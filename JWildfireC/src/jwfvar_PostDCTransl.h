...
class PostDCTranslFunc: public Variation {
public:
	PostDCTranslFunc() {
	  x0 = 0.0;
	  x1 = 1.0;
    ...
    /* post_dcztransl by Xyrus02, http://xyrus02.deviantart.com/art/DC-ZTransl-plugins-for-Apo7X-210719008?q=gallery%3Afractal-resources%2F24660058&qo=32 */
	...
	PostDCTranslFunc* makeCopy() {
		return new PostDCTranslFunc(*this);
	}
