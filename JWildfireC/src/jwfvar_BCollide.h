...
public:
    ...
    tau = 0.5f * (logf((pAffineTP->x + 1.0f)*(pAffineTP->x + 1.0f) + pAffineTP->y*pAffineTP->y) - logf((pAffineTP->x - 1.0)*(pAffineTP->x - 1.0) + pAffineTP->y*pAffineTP->y));
