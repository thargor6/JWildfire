...
class FractMandelbrotWFFunc: public AbstractFractWFFunc {
public:
	FractMandelbrotWFFunc() {
		power=2;
		initParameterNames(15, "max_iter", "xmin", "xmax", "ymin", "ymax", "direct_color", "scalez", "clip_iter_min", "clip_iter_max", "scale", "offsetx", "offsety","offsetz","max_clip_iter","power" );
	}
	...
	FractMandelbrotWFFunc* makeCopy() {
		return new FractMandelbrotWFFunc(*this);
	}
