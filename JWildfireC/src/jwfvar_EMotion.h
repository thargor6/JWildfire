 ...
 */
#ifndef JWFVAR_EMOTION_H_
#define JWFVAR_EMOTION_H_

#include "jwf_Constants.h"
#include "jwf_Variation.h"

class EMotionFunc: public Variation {
public:
	EMotionFunc() {
		move = 0.0f;
		rotate = 0.0f;
		initParameterNames(2, "move", "rotate");
	}
	...
	EMotionFunc* makeCopy() {
		return new EMotionFunc(*this);
	}
