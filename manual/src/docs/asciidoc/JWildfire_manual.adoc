...
===== _Apply all current modifications_
???
...
You may also set the default mutation-type for quick mutations in the Preferences (property tinaQuickMutationDefaultMutationType).
