...
===== _Color_ tab
During the iteration process, each point has an associated color. When a transformation maps a point to a new position,
it also gets a new color. The options on this tab give you control over exactly how these colors are calculated.
