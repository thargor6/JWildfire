...
file with the name "selftest.png" was created. Otherwise, the console output hopefully will help to solve any problems.
...
from Microsoft will help in most cases.
