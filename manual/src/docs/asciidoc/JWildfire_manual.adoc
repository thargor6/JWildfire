...
Here you can choose the type of mutation to be executed:
 ...
 - *User1*, *User2*, *User3*: user-defined lists of mutations. You may customize them in the _Preferences_ by
...
The flame-browser can help you to get an overview over your flame-fractals you create over the time.
...
If you look into this folder, you should see a file FACLRender.exe
 . Start JWildfire and open the Preferences-window. Locate the property named
...
so you can get out different images out of one flame-fractal.
