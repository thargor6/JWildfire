...
(This is very similar to the thumbnail ribbon inside <<main_editor, Main Editor>>, which hold all currently loaded flames.)
...
Appends the currently loaded flame in the <<main_editor, Main Editor>> to the movie.
