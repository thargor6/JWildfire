...
public class Desktop extends JApplet {
  ...
  private JDesktopPane getMainDesktopPane() {
    if (mainDesktopPane == null) {
      ...
      mainController = new MainController(prefs, errorHandler, mainDesktopPane,
          getWindowMenu(), getTransformerInputCmb(), getTransformerPresetCmb(), getCreatorPresetCmb(),
   ...
   */
  private JComboBox getTransformerInputCmb() {
  ...
  */
  private JInternalFrame getOperatorsInternalFrame() {
    if (operatorsInternalFrame == null) {
      operatorsInternalFrame = new JInternalFrame();
      ...
      operatorsInternalFrame.setContentPane(getOperatorsContentPane());
      operatorsInternalFrame
          .addInternalFrameListener(new javax.swing.event.InternalFrameAdapter() {
            public void internalFrameDeactivated(
                javax.swing.event.InternalFrameEvent e) {
  ...
  /**
   * This method initializes operatorsContentPane
   * 
   * @return javax.swing.JPanel
   */
  private JPanel getOperatorsContentPane() {
    if (operatorsContentPane == null) {
      operatorsContentPane = new JPanel();
      operatorsContentPane.setLayout(new BorderLayout());
      operatorsContentPane.add(getOperatorsTabbedPane(),
          BorderLayout.CENTER);
    }
    return operatorsContentPane;
  }
   ...
   * @return javax.swing.JComboBox
   */
  private JComboBox getTransformerPresetCmb() {
   ...
   * @return javax.swing.JComboBox	
   */
  private JComboBox getCreatorPresetCmb() {
  ...
  private boolean presetRefreshing = false;
  ...
  private JPanel operatorsContentPane = null;
