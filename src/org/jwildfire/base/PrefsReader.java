  ...
  public void readPrefs(Prefs pPrefs) throws Exception {
    ...
    if (file.exists()) {
      ...
      try {
        ...
        pPrefs.setSkipPathCheckAtStartup(getBooleanProperty(props, Prefs.KEY_GENERAL_SKIP_PATH_CHECK_AT_STARTUP, pPrefs.isSkipPathCheckAtStartup()));
        ...
        pPrefs.setTinaMutaGenMutationTrend(getProperty(props, Prefs.KEY_TINA_MUTAGEN_MUTATION_TREND, pPrefs.getTinaMutaGenMutationTrend()));
        ...
        pPrefs.setTinaQuickMutationBatchSize(getIntProperty(props, Prefs.KEY_TINA_QUICK_MUTATIONS_BATCH_SIZE, pPrefs.getTinaQuickMutationBatchSize()));
        pPrefs.setTinaQuickMutationDefaultMutationType(getProperty(props, Prefs.KEY_TINA_QUICK_MUTATIONS_DEFAULT_MUTATION_TYPE, pPrefs.getTinaQuickMutationDefaultMutationType()));
        ...
        pPrefs.setTinaRealtimePreviewIdleAmount(getIntProperty(props, Prefs.KEY_TINA_REALTIME_PREVIEW_IDLE_AMOUNT, pPrefs.getTinaRealtimePreviewIdleAmount()));
        try {
