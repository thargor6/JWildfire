...
public class BanchoffSurfaceBuilder extends PrimitiveBuilder<BanchoffSurfaceBuilder> implements PartBuilder {

  public BanchoffSurfaceBuilder(SunflowSceneBuilder pParent) {
    super(pParent);
  }
