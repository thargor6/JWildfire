...
public class BasicNoiseRandomWeightingFieldGenerator implements RandomWeightingFieldGenerator {
  ...
  static {
    ...
    WEIGHTING_FIELD_TYPE_LIST.add(WeightingFieldType.VALUE_NOISE);
  }
