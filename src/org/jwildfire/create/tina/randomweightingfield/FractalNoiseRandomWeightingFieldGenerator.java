...
public class FractalNoiseRandomWeightingFieldGenerator implements RandomWeightingFieldGenerator {

  private static List<WeightingFieldType> WEIGHTING_FIELD_TYPE_LIST;

  static {
    WEIGHTING_FIELD_TYPE_LIST = new ArrayList<>();
    WEIGHTING_FIELD_TYPE_LIST.add(WeightingFieldType.CUBIC_FRACTAL_NOISE);
    WEIGHTING_FIELD_TYPE_LIST.add(WeightingFieldType.PERLIN_FRACTAL_NOISE);
    WEIGHTING_FIELD_TYPE_LIST.add(WeightingFieldType.SIMPLEX_FRACTAL_NOISE);
    WEIGHTING_FIELD_TYPE_LIST.add(WeightingFieldType.VALUE_FRACTAL_NOISE);
  }
