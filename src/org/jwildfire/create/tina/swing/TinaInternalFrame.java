...
public class TinaInternalFrame extends JInternalFrame {
  ...
  public TinaController createController(StandardErrorHandler pErrorHandler, Prefs pPrefs, MutaGenInternalFrame mutaGenFrame, FlameBrowserInternalFrame flameBrowserFrame, EasyMovieMakerInternalFrame easyMovieMakerInternalFrame) {
    ...
    initRandomMovieGenCmb(easyMovieMakerInternalFrame.getSwfAnimatorRandGenCmb());
    ...
    initMeshGenOutputTypeCmb(getMeshGenOutputTypeCmb());
    ...
    params.setEasyMovieMakerParams(easyMovieMakerInternalFrame.getSwfAnimatorResolutionProfileCmb(), easyMovieMakerInternalFrame.getSwfAnimatorQualityProfileCmb());
    ...
    params.setParams1(this, pErrorHandler, pPrefs,/* getCenterCenterPanel()*/getMainPrevievPnl(), getTinaCameraRollREd(), getTinaCameraRollSlider(), getTinaCameraPitchREd(),
        ...
        getTinaRenderFlameButton(), getRenderMainButton(), getTinaAppendToMovieButton(),
    ...
    params.setParams3(getMeshGenFromEditorBtn(), getMeshGenFromClipboardBtn(), getMeshGenLoadFlameBtn(), getMeshGenSliceCountREd(),
        ...
        getTinaSolidRenderingLightIntensitySlider(), getTinaSolidRenderingSelectedMaterialCmb(), getTinaSolidRenderingAddMaterialBtn(),
    ...
    try {
      ...
      initGlobalScriptCmb(easyMovieMakerInternalFrame.getSwfAnimatorGlobalScript1Cmb());
      initGlobalScriptCmb(easyMovieMakerInternalFrame.getSwfAnimatorGlobalScript2Cmb());
      initGlobalScriptCmb(easyMovieMakerInternalFrame.getSwfAnimatorGlobalScript3Cmb());
      initGlobalScriptCmb(easyMovieMakerInternalFrame.getSwfAnimatorGlobalScript4Cmb());
      initGlobalScriptCmb(easyMovieMakerInternalFrame.getSwfAnimatorGlobalScript5Cmb());
      initGlobalScriptCmb(easyMovieMakerInternalFrame.getSwfAnimatorGlobalScript6Cmb());
      initGlobalScriptCmb(easyMovieMakerInternalFrame.getSwfAnimatorGlobalScript7Cmb());
      initGlobalScriptCmb(easyMovieMakerInternalFrame.getSwfAnimatorGlobalScript8Cmb());
      initGlobalScriptCmb(easyMovieMakerInternalFrame.getSwfAnimatorGlobalScript9Cmb());
      initGlobalScriptCmb(easyMovieMakerInternalFrame.getSwfAnimatorGlobalScript10Cmb());
      initGlobalScriptCmb(easyMovieMakerInternalFrame.getSwfAnimatorGlobalScript11Cmb());
      initGlobalScriptCmb(easyMovieMakerInternalFrame.getSwfAnimatorGlobalScript12Cmb());

      initXFormScriptCmb(easyMovieMakerInternalFrame.getSwfAnimatorXFormScript1Cmb());
      initXFormScriptCmb(easyMovieMakerInternalFrame.getSwfAnimatorXFormScript2Cmb());
      initXFormScriptCmb(easyMovieMakerInternalFrame.getSwfAnimatorXFormScript3Cmb());
      initXFormScriptCmb(easyMovieMakerInternalFrame.getSwfAnimatorXFormScript4Cmb());
      initXFormScriptCmb(easyMovieMakerInternalFrame.getSwfAnimatorXFormScript5Cmb());
      initXFormScriptCmb(easyMovieMakerInternalFrame.getSwfAnimatorXFormScript6Cmb());
      initXFormScriptCmb(easyMovieMakerInternalFrame.getSwfAnimatorXFormScript7Cmb());
      initXFormScriptCmb(easyMovieMakerInternalFrame.getSwfAnimatorXFormScript8Cmb());
      initXFormScriptCmb(easyMovieMakerInternalFrame.getSwfAnimatorXFormScript9Cmb());
      initXFormScriptCmb(easyMovieMakerInternalFrame.getSwfAnimatorXFormScript10Cmb());
      initXFormScriptCmb(easyMovieMakerInternalFrame.getSwfAnimatorXFormScript11Cmb());
      initXFormScriptCmb(easyMovieMakerInternalFrame.getSwfAnimatorXFormScript12Cmb());

      initSequenceOutputType(easyMovieMakerInternalFrame.getSwfAnimatorOutputTypeCmb());
      ...
      JComboBox[] globalScriptCmbArray = {
          easyMovieMakerInternalFrame.getSwfAnimatorGlobalScript1Cmb(), easyMovieMakerInternalFrame.getSwfAnimatorGlobalScript2Cmb(), easyMovieMakerInternalFrame.getSwfAnimatorGlobalScript3Cmb(),
          easyMovieMakerInternalFrame.getSwfAnimatorGlobalScript4Cmb(), easyMovieMakerInternalFrame.getSwfAnimatorGlobalScript5Cmb(), easyMovieMakerInternalFrame.getSwfAnimatorGlobalScript6Cmb(),
          easyMovieMakerInternalFrame.getSwfAnimatorGlobalScript7Cmb(), easyMovieMakerInternalFrame.getSwfAnimatorGlobalScript8Cmb(), easyMovieMakerInternalFrame.getSwfAnimatorGlobalScript9Cmb(),
          easyMovieMakerInternalFrame.getSwfAnimatorGlobalScript10Cmb(), easyMovieMakerInternalFrame.getSwfAnimatorGlobalScript11Cmb(), easyMovieMakerInternalFrame.getSwfAnimatorGlobalScript12Cmb() };
      JWFNumberField[] globalScriptREdArray = {
          easyMovieMakerInternalFrame.getSwfAnimatorGlobalScript1REd(), easyMovieMakerInternalFrame.getSwfAnimatorGlobalScript2REd(), easyMovieMakerInternalFrame.getSwfAnimatorGlobalScript3REd(),
          easyMovieMakerInternalFrame.getSwfAnimatorGlobalScript4REd(), easyMovieMakerInternalFrame.getSwfAnimatorGlobalScript5REd(), easyMovieMakerInternalFrame.getSwfAnimatorGlobalScript6REd(),
          easyMovieMakerInternalFrame.getSwfAnimatorGlobalScript7REd(), easyMovieMakerInternalFrame.getSwfAnimatorGlobalScript8REd(), easyMovieMakerInternalFrame.getSwfAnimatorGlobalScript9REd(),
          easyMovieMakerInternalFrame.getSwfAnimatorGlobalScript10REd(), easyMovieMakerInternalFrame.getSwfAnimatorGlobalScript11REd(), easyMovieMakerInternalFrame.getSwfAnimatorGlobalScript12REd() };
      JComboBox[] xFormScriptCmbArray = {
          easyMovieMakerInternalFrame.getSwfAnimatorXFormScript1Cmb(), easyMovieMakerInternalFrame.getSwfAnimatorXFormScript2Cmb(), easyMovieMakerInternalFrame.getSwfAnimatorXFormScript3Cmb(),
          easyMovieMakerInternalFrame.getSwfAnimatorXFormScript4Cmb(), easyMovieMakerInternalFrame.getSwfAnimatorXFormScript5Cmb(), easyMovieMakerInternalFrame.getSwfAnimatorXFormScript6Cmb(),
          easyMovieMakerInternalFrame.getSwfAnimatorXFormScript7Cmb(), easyMovieMakerInternalFrame.getSwfAnimatorXFormScript8Cmb(), easyMovieMakerInternalFrame.getSwfAnimatorXFormScript9Cmb(),
          easyMovieMakerInternalFrame.getSwfAnimatorXFormScript10Cmb(), easyMovieMakerInternalFrame.getSwfAnimatorXFormScript11Cmb(), easyMovieMakerInternalFrame.getSwfAnimatorXFormScript12Cmb() };
      JWFNumberField[] xFormScriptREdArray = {
          easyMovieMakerInternalFrame.getSwfAnimatorXFormScript1REd(), easyMovieMakerInternalFrame.getSwfAnimatorXFormScript2REd(), easyMovieMakerInternalFrame.getSwfAnimatorXFormScript3REd(),
          easyMovieMakerInternalFrame.getSwfAnimatorXFormScript4REd(), easyMovieMakerInternalFrame.getSwfAnimatorXFormScript5REd(), easyMovieMakerInternalFrame.getSwfAnimatorXFormScript6REd(),
          easyMovieMakerInternalFrame.getSwfAnimatorXFormScript7REd(), easyMovieMakerInternalFrame.getSwfAnimatorXFormScript8REd(), easyMovieMakerInternalFrame.getSwfAnimatorXFormScript9REd(),
          easyMovieMakerInternalFrame.getSwfAnimatorXFormScript10REd(), easyMovieMakerInternalFrame.getSwfAnimatorXFormScript11REd(), easyMovieMakerInternalFrame.getSwfAnimatorXFormScript12REd() };
      ...
      tinaController.setSwfAnimatorCtrl(new TinaSWFAnimatorController(tinaController, pErrorHandler, pPrefs,
          ...
          easyMovieMakerInternalFrame.getSwfAnimatorFramesREd(), easyMovieMakerInternalFrame.getSwfAnimatorFramesPerSecondREd(),
          easyMovieMakerInternalFrame.getSwfAnimatorGenerateButton(), easyMovieMakerInternalFrame.getSwfAnimatorResolutionProfileCmb(),
          easyMovieMakerInternalFrame.getSwfAnimatorLoadFlameFromMainButton(),
          easyMovieMakerInternalFrame.getSwfAnimatorLoadFlameFromClipboardButton(), easyMovieMakerInternalFrame.getSwfAnimatorLoadFlameButton(),
          easyMovieMakerInternalFrame.getSwfAnimatorProgressBar(), easyMovieMakerInternalFrame.getSwfAnimatorCancelButton(),
          new SWFAnimatorProgressUpdater(easyMovieMakerInternalFrame), easyMovieMakerInternalFrame.getSwfAnimatorPreviewRootPanel(),
          easyMovieMakerInternalFrame.getSwfAnimatorFrameSlider(), easyMovieMakerInternalFrame.getSwfAnimatorFrameREd(),
          easyMovieMakerInternalFrame.getSwfAnimatorFlamesPanel(), easyMovieMakerInternalFrame.getSwfAnimatorFlamesButtonGroup(),
          easyMovieMakerInternalFrame.getSwfAnimatorMoveUpButton(), easyMovieMakerInternalFrame.getSwfAnimatorMoveDownButton(),
          easyMovieMakerInternalFrame.getSwfAnimatorRemoveFlameButton(),
          easyMovieMakerInternalFrame.getSwfAnimatorRemoveAllFlamesButton(), easyMovieMakerInternalFrame.getSwfAnimatorMovieFromClipboardButton(),
          easyMovieMakerInternalFrame.getSwfAnimatorMovieFromDiscButton(),
          easyMovieMakerInternalFrame.getSwfAnimatorMovieToClipboardButton(), easyMovieMakerInternalFrame.getSwfAnimatorMovieToDiscButton(),
          easyMovieMakerInternalFrame.getSwfAnimatorFrameToEditorBtn(),
          easyMovieMakerInternalFrame.getSwfAnimatorPlayButton(), easyMovieMakerInternalFrame.getSwfAnimatorMotionBlurLengthREd(),
          easyMovieMakerInternalFrame.getSwfAnimatorMotionBlurTimeStepREd(), easyMovieMakerInternalFrame.getRandomMoviePanel(),
          easyMovieMakerInternalFrame.getSwfAnimatorQualityProfileCmb(), easyMovieMakerInternalFrame.getSwfAnimatorOutputTypeCmb()));
  ...
  private JWFNumberField tinaSolidRenderingLightPosZREd;
  private JSlider tinaSolidRenderingLightPosXSlider;
  private JSlider tinaSolidRenderingLightPosYSlider;
  private JSlider tinaSolidRenderingLightPosZSlider;
  ...
  private JSlider getPostBlurFadeSlider() {
    if (postBlurFadeSlider == null) {
      ...
      postBlurFadeSlider.setSize(new Dimension(120, 19));
  ...
  private JButton getTinaAppendToDancingFlamesButton() {
    if (tinaAppendToDancingFlamesButton == null) {
      ...
      tinaAppendToDancingFlamesButton.setFont(Prefs.getPrefs().getFont("Dialog", Font.BOLD, 9));
  ...
  private JTabbedPane getTinaSolidRenderingPane() {
    if (tinaSolidRenderingPane == null) {
      ...
      tinaSolidRenderingLightPosXLbl.setLocation(new Point(390, 6));
      tinaSolidRenderingLightPosXLbl.setFont(Prefs.getPrefs().getFont("Dialog", Font.BOLD, 10));
      tinaSolidRenderingLightPosXLbl.setBounds(6, 37, 68, 22);
      tinaSolidRenderingLightPnl.add(tinaSolidRenderingLightPosXLbl);

      tinaSolidRenderingLightPosXREd = new JWFNumberField();
      tinaSolidRenderingLightPosXREd.setValueStep(0.05);
      tinaSolidRenderingLightPosXREd.setText("");
      tinaSolidRenderingLightPosXREd.setSize(new Dimension(100, 24));
      tinaSolidRenderingLightPosXREd.setPreferredSize(new Dimension(100, 24));
      tinaSolidRenderingLightPosXREd.setMotionPropertyName("camPosX");
      tinaSolidRenderingLightPosXREd.setLocation(new Point(456, 4));
      tinaSolidRenderingLightPosXREd.setLinkedMotionControlName("tinaSolidRenderingLightPosXSlider");
      ...
      tinaSolidRenderingLightPosXSlider.setValue(0);
      tinaSolidRenderingLightPosXSlider.setSize(new Dimension(205, 19));
      tinaSolidRenderingLightPosXSlider.setPreferredSize(new Dimension(220, 19));
      tinaSolidRenderingLightPosXSlider.setName("tinaSolidRenderingLightPosXSlider");
      tinaSolidRenderingLightPosXSlider.setMinimum(-25000);
      ...
      tinaSolidRenderingLightPosYLbl.setLocation(new Point(390, 6));
      tinaSolidRenderingLightPosYLbl.setFont(Prefs.getPrefs().getFont("Dialog", Font.BOLD, 10));
      tinaSolidRenderingLightPosYLbl.setBounds(6, 61, 68, 22);
      tinaSolidRenderingLightPnl.add(tinaSolidRenderingLightPosYLbl);

      tinaSolidRenderingLightPosYREd = new JWFNumberField();
      tinaSolidRenderingLightPosYREd.setValueStep(0.05);
      tinaSolidRenderingLightPosYREd.setText("");
      tinaSolidRenderingLightPosYREd.setSize(new Dimension(100, 24));
      tinaSolidRenderingLightPosYREd.setPreferredSize(new Dimension(100, 24));
      tinaSolidRenderingLightPosYREd.setMotionPropertyName("camPosY");
      tinaSolidRenderingLightPosYREd.setLocation(new Point(456, 4));
      tinaSolidRenderingLightPosYREd.setLinkedMotionControlName("tinaSolidRenderingLightPosYSlider");
      ...
      tinaSolidRenderingLightPosYSlider.setValue(0);
      tinaSolidRenderingLightPosYSlider.setSize(new Dimension(205, 19));
      tinaSolidRenderingLightPosYSlider.setPreferredSize(new Dimension(220, 19));
      tinaSolidRenderingLightPosYSlider.setName("tinaSolidRenderingLightPosYSlider");
      tinaSolidRenderingLightPosYSlider.setMinimum(-25000);
      ...
      tinaSolidRenderingLightPosZLbl.setLocation(new Point(390, 6));
      tinaSolidRenderingLightPosZLbl.setFont(Prefs.getPrefs().getFont("Dialog", Font.BOLD, 10));
      tinaSolidRenderingLightPosZLbl.setBounds(7, 85, 68, 22);
      tinaSolidRenderingLightPnl.add(tinaSolidRenderingLightPosZLbl);

      tinaSolidRenderingLightPosZREd = new JWFNumberField();
      tinaSolidRenderingLightPosZREd.setValueStep(0.05);
      tinaSolidRenderingLightPosZREd.setText("");
      tinaSolidRenderingLightPosZREd.setSize(new Dimension(100, 24));
      tinaSolidRenderingLightPosZREd.setPreferredSize(new Dimension(100, 24));
      tinaSolidRenderingLightPosZREd.setMotionPropertyName("camPosZ");
      tinaSolidRenderingLightPosZREd.setLocation(new Point(456, 4));
      tinaSolidRenderingLightPosZREd.setLinkedMotionControlName("tinaSolidRenderingLightPosZSlider");
      ...
      tinaSolidRenderingLightPosZSlider.setValue(0);
      tinaSolidRenderingLightPosZSlider.setSize(new Dimension(205, 19));
      tinaSolidRenderingLightPosZSlider.setPreferredSize(new Dimension(220, 19));
      tinaSolidRenderingLightPosZSlider.setName("tinaSolidRenderingLightPosZSlider");
      tinaSolidRenderingLightPosZSlider.setMinimum(-25000);
      ...
      tinaSolidRenderingLightColorBtn.setBounds(500, 23, 56, 46);
      ...
      tinaSolidRenderingLightIntensityLbl0.setBounds(434, 83, 68, 22);
  ...
  private JButton getResetSolidRenderingMaterialsBtn() {
    if (resetSolidRenderingMaterialsBtn == null) {
      ...
      resetSolidRenderingMaterialsBtn.setBounds(6, 114, 100, 24);
  ...
  private JPanel getPanel_114() {
    if (panel_114 == null) {
      ...
      tinaSolidRenderingMaterialReflectionMapIntensityLbl.setFont(new Font("Dialog", Font.BOLD, 10));
      ...
      tinaSolidRenderingMaterialReflectionMapIntensityREd.setFont(new Font("Dialog", Font.PLAIN, 10));
  ...
  private JButton getResetSolidRenderingLightsBtn() {
    if (resetSolidRenderingLightsBtn == null) {
      ...
      resetSolidRenderingLightsBtn.setBounds(592, 1, 100, 24);
  ...
  public JWFNumberField getTinaSolidRenderingLightPosXREd() {
    return tinaSolidRenderingLightPosXREd;
  }

  public JWFNumberField getTinaSolidRenderingLightPosYREd() {
    return tinaSolidRenderingLightPosYREd;
  }

  public JWFNumberField getTinaSolidRenderingLightPosZREd() {
    return tinaSolidRenderingLightPosZREd;
  }

  public JSlider getTinaSolidRenderingLightPosXSlider() {
    return tinaSolidRenderingLightPosXSlider;
  }

  public JSlider getTinaSolidRenderingLightPosYSlider() {
    return tinaSolidRenderingLightPosYSlider;
  }

  public JSlider getTinaSolidRenderingLightPosZSlider() {
    return tinaSolidRenderingLightPosZSlider;
  }
  ...
  private JButton getTinaSolidRenderingMaterialSelectReflMapBtn() {
    if (tinaSolidRenderingMaterialSelectReflMapBtn == null) {
      ...
      tinaSolidRenderingMaterialSelectReflMapBtn.setFont(new Font("Dialog", Font.BOLD, 10));
  ...
  private JButton getTinaSolidRenderingMaterialRemoveReflMapBtn() {
    if (tinaSolidRenderingMaterialRemoveReflMapBtn == null) {
      ...
      tinaSolidRenderingMaterialRemoveReflMapBtn.setFont(new Font("Dialog", Font.BOLD, 10));
  ...
  private JLabel getLblReflectionMap() {
    if (lblReflectionMap == null) {
      ...
      lblReflectionMap.setFont(new Font("Dialog", Font.BOLD, 10));
