...
public class DCGnarlyFunc extends VariationFunc implements SupportsGPU {
  ...
  public String getGPUCode(FlameTransformationContext context) {
    return "float x0 = __x;\n"
        + " float y0 = __y;\n"
        + "    if (__dc_gnarly_blur > 0) {\n"
        + "      float r = RANDFLOAT() * 2 * PI;\n"
        + "      float sina = sinf(r);\n"
        + "      float cosa = cosf(r);\n"
        + "      r = __dc_gnarly_blur * (RANDFLOAT() + RANDFLOAT() + RANDFLOAT() + RANDFLOAT() + RANDFLOAT() + RANDFLOAT() - 3.f);\n"
        + "      x0 += r * cosa;\n"
        + "      y0 += r * sina;\n"
        + "    } else if (__dc_gnarly_blur < 0) {\n"
        + "      x0 += RANDFLOAT() * __dc_gnarly_blur * 2.f - __dc_gnarly_blur;\n"
        + "      y0 += RANDFLOAT() * __dc_gnarly_blur * 2.f - __dc_gnarly_blur;\n"
        + "    }\n"
        + "\n"
        + "    float x1, y1;\n"
        + "    switch (lroundf(__dc_gnarly_mode)) {\n"
        + "      case 1:\n"
        + "        x1 = cosf(__dc_gnarly_freqx1 * y0 + sinf(__dc_gnarly_freqx2 * (y0 + sinf(__dc_gnarly_freqx3 * y0)))) * __dc_gnarly_scalex;\n"
        + "        y1 = cosf(__dc_gnarly_freqy1 * x0 + sinf(__dc_gnarly_freqy2 * (x0 + sinf(__dc_gnarly_freqy3 * x0)))) * __dc_gnarly_scaley;\n"
        + "        break;\n"
        + "      case 2:\n"
        + "        x1 = sinf(__dc_gnarly_freqx1 * y0 + sinf(__dc_gnarly_freqx2 * (y0 + cosf(__dc_gnarly_freqx3 * y0)))) * __dc_gnarly_scalex;\n"
        + "        y1 = sinf(__dc_gnarly_freqy1 * x0 + sinf(__dc_gnarly_freqy2 * (x0 + cosf(__dc_gnarly_freqy3 * x0)))) * __dc_gnarly_scaley;\n"
        + "        break;\n"
        + "      case 3:\n"
        + "        x1 = cosf(__dc_gnarly_freqx1 * y0 + sinf(__dc_gnarly_freqx2 * (x0 + sinf(__dc_gnarly_freqx3 * y0)))) * __dc_gnarly_scalex;\n"
        + "        y1 = cosf(__dc_gnarly_freqy1 * x0 + sinf(__dc_gnarly_freqy2 * (y0 + sinf(__dc_gnarly_freqy3 * x0)))) * __dc_gnarly_scaley;\n"
        + "        break;\n"
        + "      case 4:\n"
        + "        x1 = sinf(__dc_gnarly_freqx1 * y0 + sinf(sqrtf(fabsf(__dc_gnarly_freqx2 * (y0 + cosf(__dc_gnarly_freqx3 * y0)))))) * __dc_gnarly_scalex;\n"
        + "        y1 = sinf(__dc_gnarly_freqy1 * x0 + sinf(sqrtf(fabsf(__dc_gnarly_freqy2 * (x0 + cosf(__dc_gnarly_freqy3 * x0)))))) * __dc_gnarly_scaley;\n"
        + "        break;\n"
        + "      case 5:\n"
        + "        x1 = cosf(__dc_gnarly_freqx1 * y0 + asinhf(__dc_gnarly_freqx2 * (y0 + sinf(__dc_gnarly_freqx3 * y0)))) * __dc_gnarly_scalex;\n"
        + "        y1 = cosf(__dc_gnarly_freqy1 * x0 + asinhf(__dc_gnarly_freqy2 * (x0 + sinf(__dc_gnarly_freqy3 * x0)))) * __dc_gnarly_scaley;\n"
        + "        break;\n"
        + "      case 6:\n"
        + "        x1 = cosf(__dc_gnarly_freqx1 * y0 + tan(__dc_gnarly_freqx2 * (y0 + sinf(__dc_gnarly_freqx3 * y0)))) * __dc_gnarly_scalex;\n"
        + "        y1 = cosf(__dc_gnarly_freqy1 * x0 + tan(__dc_gnarly_freqy2 * (x0 + sinf(__dc_gnarly_freqy3 * x0)))) * __dc_gnarly_scaley;\n"
        + "        break;\n"
        + "      case 7:\n"
        + "        x1 = sinf(__dc_gnarly_freqx1 * y0 + sinf(sqrf(__dc_gnarly_freqx2 * (y0 + cosf(__dc_gnarly_freqx3 * y0))))) * __dc_gnarly_scalex;\n"
        + "        y1 = sinf(__dc_gnarly_freqy1 * x0 + sinf(sqrf(__dc_gnarly_freqy2 * (x0 + cosf(__dc_gnarly_freqy3 * x0))))) * __dc_gnarly_scaley;\n"
        + "        break;\n"
        + "      case 8:\n"
        + "        x1 = sinf(__dc_gnarly_freqx1 * y0 + sinf(sqrf(__dc_gnarly_freqx2 * (x0 + cosf(__dc_gnarly_freqx3 * y0))))) * __dc_gnarly_scalex;\n"
        + "        y1 = sinf(__dc_gnarly_freqy1 * x0 + sinf(sqrf(__dc_gnarly_freqy2 * (y0 + cosf(__dc_gnarly_freqy3 * x0))))) * __dc_gnarly_scaley;\n"
        + "        break;\n"
        + "      default:\n"
        + "        x1 = sinf(__dc_gnarly_freqx1 * y0) * __dc_gnarly_scalex;\n"
        + "        y1 = sinf(__dc_gnarly_freqy1 * x0) * __dc_gnarly_scaley;\n"
        + "        break;\n"
        + "    }\n"
        + "    float s1 = logf(sqrtf(x1*x1 + y1*y1)) * __dc_gnarly_distort;\n"
        + "\n"
        + "    __px += __dc_gnarly * (x0 + x1) / 2;\n"
        + "    __py += __dc_gnarly * (y0 + y1) / 2;\n"
        + "\n"
        + "    if (lroundf(__dc_gnarly_dc) != 0) {\n"
        + "      __pal = fmodf(fabsf(cosf(x0 + x1 * __dc_gnarly_color1 + s1) + sinf(y0 + y1 * __dc_gnarly_color2 + s1)), __dc_gnarly_fmag);\n"
        + "    }\n"
        + "\n"
        + "    float dz = __pal * __dc_gnarly_scale_z + __dc_gnarly_offset_z;\n"
        + "    if (lroundf(__dc_gnarly_reset_z) > 0) {\n"
        + "      __pz = dz;\n"
        + "    } else {\n"
        + "      __pz += dz;\n"
        + "    }\n";
