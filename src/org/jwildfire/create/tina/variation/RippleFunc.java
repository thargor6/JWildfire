...
public class RippleFunc extends VariationFunc implements SupportsGPU {
  ...
  public String getGPUCode(FlameTransformationContext context) {
    return "  float _f, _s, _p, _is, _pxa, _pixa, _vxp;\n"
        ...
        + "_f = __ripple_frequency * 5;\n"
        + "    float a = __ripple_amplitude * 0.01;\n"
        + "    _p = __ripple_phase * (2.0f*PI) - PI;\n"
        + "    _s = __ripple_scale == 0 ? 1.e-6f : __ripple_scale;\n"
        + "    _is = 1.0 / _s;\n"
        + "    _vxp = __ripple_velocity * _p;\n"
        + "    _pxa = _p * a;\n"
        + "    _pixa = (PI - _p) * a;\n"
        + "    _fixed_dist_calc = lroundf(__ripple_fixed_dist_calc != 0);\n"
        + "    float x = (__x * _s) - __ripple_centerx, y = (__y * _s) + __ripple_centery;\n"
        ...
        + "    float u1 = (__ripple_centerx + nx * d1), v1 = (-__ripple_centery + ny * d1);\n"
        + "    float u2 = (__ripple_centerx + nx * d2), v2 = (-__ripple_centery + ny * d2);\n"
        + "    __px = __ripple * (lerpf(u1, u2, _p)) * _is;\n"
        + "    __py = __ripple * (lerpf(v1, v2, _p)) * _is;\n"
        + (context.isPreserveZCoordinate() ? "__pz = __ripple * __z;\n" : "");
  }
}
