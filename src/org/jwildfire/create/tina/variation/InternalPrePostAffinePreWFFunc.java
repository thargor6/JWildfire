...
public class InternalPrePostAffinePreWFFunc extends VariationFunc implements PrePostGPUImplementation {
  ...
  public String getGPUCode(FlameTransformationContext context) {
    return "float coefxx, coefxy, coefxz, coefyx, coefyy, coefyz, coefzx, coefzy, coefzz;\n"
            ...
            + "float d2r = PI / 180.f;\n"
            + "    float sinyaw = sinf(varpar->pre_prepost_affine_yaw * d2r), cosyaw = cosf(varpar->pre_prepost_affine_yaw * d2r);\n"
            + "    float sinpitch = sinf(varpar->pre_prepost_affine_pitch * d2r), cospitch = cosf(varpar->pre_prepost_affine_pitch * d2r);\n"
            + "    float sinroll = sinf(varpar->pre_prepost_affine_roll * d2r), cosroll = cosf(varpar->pre_prepost_affine_roll * d2r);\n"
            + "\n"
            ...
            + "if (varpar->pre_prepost_affine != 0) {\n"
            + "    float x = __x - varpar->pre_prepost_affine_move_x;\n"
            + "    float y = __y - varpar->pre_prepost_affine_move_y;\n"
            + "    float z = __z - varpar->pre_prepost_affine_move_z;\n"
            + "    __x = (icoefxx * x + icoefxy * y + icoefxz * z) / (varpar->pre_prepost_affine * varpar->pre_prepost_affine_scale_x);\n"
            + "    __y = (icoefyx * x + icoefyy * y + icoefyz * z) / (varpar->pre_prepost_affine * varpar->pre_prepost_affine_scale_y);\n"
            + "    __z = (icoefzx * x + icoefzy * y + icoefzz * z) / (varpar->pre_prepost_affine * varpar->pre_prepost_affine_scale_z);\n"
