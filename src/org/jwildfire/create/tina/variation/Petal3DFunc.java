...
public class Petal3DFunc extends VariationFunc implements SupportsGPU {
    ...
    return "float ax = cosf(__x * __petal3D_warp);\n"
        + "  float bx = (cosf(__x + __petal3D_x1) * cosf(__y + __petal3D_x2)) * (cosf(__x + __petal3D_x3) * cosf(__y + __petal3D_x4))\n"
        + "    * (cosf(__x + __petal3D_x5) * cosf(__y + __petal3D_x6));\n"
        + "  float by = (sinf(__x + __petal3D_y1) * cosf(__y + __petal3D_y2)) * (sinf(__x + __petal3D_y3) * cosf(__y + __petal3D_y4))\n"
        + "    * (sinf(__x + __petal3D_y5) * cosf(__y + __petal3D_y6));\n"
        + "  float zy = (sinf(__z + __petal3D_z1) * cosf(__y + __petal3D_z2)) * (sinf(__z + __petal3D_z3) * cosf(__y + __petal3D_z4))\n"
        + "    * (sinf(__z + __petal3D_z5) * cosf(__y + __petal3D_z6));\n"
        + "  float zx = (sinf(__z + __petal3D_z1) * cosf(__x + __petal3D_z2)) * (sinf(__z + __petal3D_z3) * cosf(__x + __petal3D_z4))\n"
        + "    * (sinf(__z + __petal3D_z5) * cosf(__x + __petal3D_z6));\n"
        + "  float yz = (sinf(__y + __petal3D_z1) * cosf(__z + __petal3D_z2)) * (sinf(__y + __petal3D_z3) * cosf(__z + __petal3D_z4))\n"
        + "    * (sinf(__y + __petal3D_z5) * cosf(__z + __petal3D_z6));\n"
        + "  float xz = (sinf(__x + __petal3D_z1) * cosf(__z + __petal3D_z2)) * (sinf(__x + __petal3D_z3) * cosf(__z + __petal3D_z4))\n"
        + "    * (sinf(__x + __petal3D_z5) * cosf(__z + __petal3D_z6));\n"
