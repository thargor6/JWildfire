	 ...
	 @Override
	  public String getGPUCode(FlameTransformationContext context) {
	    return   "float x,y;"
	    		...
	    		+"  y=RANDFLOAT()-0.5;"
	    		+"}"
	    		+"float2 uv=make_float2(x,y)*__dc_portal_zoom;"
	    		+"color=dc_portal_getRGBColor(uv,__dc_portal_time,__dc_portal_waves);"
	    		+"if( __dc_portal_Gradient ==0 )"
	    		+"{"
	    		+"   __useRgb  = true;"
	    		+"   __colorR  = color.x;"
	    		+"   __colorG  = color.y;"
	    		...
	    		+"   __colorA  = 1.0;"
	    		+"}"
	    		+"else if( __dc_portal_Gradient ==1 )"
	    		+"{"
...
////use nearest palette color as the pixel color                
	    		...
	    		+"   __colorA  = 1.0;"
	    		+"}"
	    		+"else if( __dc_portal_Gradient ==2 )"
	    		+"{"
	    		...
	    		+"__px+= __dc_portal*x;"
	    		+"__py+= __dc_portal*y;"
	    		+"float dz = z * __dc_portal_scale_z + __dc_portal_offset_z;"
	    		+"if ( __dc_portal_reset_z  == 1) {"
	    		+"     __pz = dz;"
	    		+"}"
	    		+"else {"
	    		+"   __pz += dz;"
