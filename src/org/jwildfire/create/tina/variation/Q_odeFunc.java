...
public class Q_odeFunc extends VariationFunc implements SupportsGPU {
  ...
  public String getGPUCode(FlameTransformationContext context) {
    return "   __px += __q_ode_q_ode01 + __q_ode * __q_ode_q_ode02 * __x + __q_ode_q_ode03 * __x * __x;\n"
        + "    __px += __q_ode_q_ode04 * __x * __y + __q_ode_q_ode05 * __y + __q_ode_q_ode06 * __y * __y;\n"
        + "    __py += __q_ode_q_ode07 + __q_ode_q_ode08 * __x + __q_ode_q_ode09 * __x * __x;\n"
        + "    __py += __q_ode_q_ode10 * __x * __y + __q_ode * __q_ode_q_ode11 * __y\n"
        + "            + __q_ode_q_ode12 * __y * __y;\n"
        + (context.isPreserveZCoordinate() ? "__pz += __q_ode * __z;\n" : "");
  }
}
