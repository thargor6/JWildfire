...
*/
  ...
  public String getGPUCode(FlameTransformationContext context) {
    return " float t1 = __mobiq_qat;\n"
        + "    float t2 = __x;\n"
        + "    float t3 = __mobiq_qbt;\n"
        + "    float t4 = __mobiq_qct;\n"
        + "    float t5 = __mobiq_qdt;\n"
        + "    float x1 = __mobiq_qax;\n"
        + "    float x2 = __y;\n"
        + "    float x3 = __mobiq_qbx;\n"
        + "    float x4 = __mobiq_qcx;\n"
        + "    float x5 = __mobiq_qdx;\n"
        + "    float y1 = __mobiq_qay;\n"
        + "    float y2 = __z;\n"
        + "    float y3 = __mobiq_qby;\n"
        + "    float y4 = __mobiq_qcy;\n"
        + "    float y5 = __mobiq_qdy;\n"
        + "    float z1 = __mobiq_qaz;\n"
        + "    float z3 = __mobiq_qbz;\n"
        + "    float z4 = __mobiq_qcz;\n"
        + "    float z5 = __mobiq_qdz;\n"
        + "\n"
        ...
        + "    float ni = __mobiq / (dt*dt + dx*dx + dy*dy + dz*dz);\n"
        + "\n"
        + "\n"
