...
public class PostAxisSymmetryWFFunc extends VariationFunc {
  ...
  private static final String[] paramNames = { PARAM_CENTRE_X, PARAM_CENTRE_Y, PARAM_ORDER };
  ...
  public void transform(FlameTransformationContext pContext, XForm pXForm, XYZPoint pAffineTP, XYZPoint pVarTP, double pAmount) {
    double dx = pVarTP.x - centre_x;
    double dy = pVarTP.y - centre_y;
  ...
  public Object[] getParameterValues() {
    return new Object[] { centre_x, centre_y, order };
  }
