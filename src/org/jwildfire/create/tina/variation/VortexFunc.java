	 ...
	 @Override
	  public String getGPUCode(FlameTransformationContext context) {
	    return   "   float2 uv =make_float2(__x,__y);"
	    		+"   float2 p = uv + make_float2(0.0,varpar->vortex_UpDown);"
	    		+"   for (int i = 0; i < varpar->vortex_flowVel ; i ++) "
	    		+"      	p = p-vortex_FlowField (p, varpar->vortex_time, varpar->vortex_zoom,varpar->vortex_vSep,varpar->vortex_v_viDistance,varpar->vortex_vDiameter  )* 0.03;"
	    		+"   __px += varpar->vortex * p.x ;"
	    		+"   __py += varpar->vortex * p.y ;"
	            + (context.isPreserveZCoordinate() ? "__pz += varpar->vortex * __z;\n" : "");
	  }
