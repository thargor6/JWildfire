...
public class PolarPlot2DWFFuncPreset extends WFFuncPreset {
  private final String formula;
  private final double tmin, tmax;
  private final double param_a, param_b, param_c, param_d, param_e, param_f;

  public PolarPlot2DWFFuncPreset(int id, String formula, double tmin, double tmax, double param_a, double param_b, double param_c, double param_d, double param_e, double param_f) {
    super(id);
