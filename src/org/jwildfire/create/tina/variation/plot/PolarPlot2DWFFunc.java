...
public class PolarPlot2DWFFunc extends VariationFunc implements SupportsGPU {
  ...
  public VariationFuncType[] getVariationTypes() {
    return new VariationFuncType[]{VariationFuncType.VARTYPE_3D, VariationFuncType.VARTYPE_BASE_SHAPE, VariationFuncType.VARTYPE_DC, VariationFuncType.VARTYPE_EDIT_FORMULA, VariationFuncType.VARTYPE_SUPPORTS_GPU, VariationFuncType.VARTYPE_SUPPORTED_BY_SWAN};
  }
  ...
  public String getGPUCode(FlameTransformationContext context) {
    return "float _tmin, _tmax, _dt;\n"
        ...
        + "_tmin = __polarplot2d_wf_tmin;\n"
        + "    _tmax = __polarplot2d_wf_tmax;\n"
        + "    if (_tmin > _tmax) {\n"
        + "      float t = _tmin;\n"
        + "      _tmin = _tmax;\n"
        + "      _tmax = t;\n"
        ...
        + "    _dt = _tmax - _tmin;\n"
        + "\n"
        + "    _rmin = __polarplot2d_wf_rmin;\n"
        + "    _rmax = __polarplot2d_wf_rmax;\n"
        + "    if (_rmin > _rmax) {\n"
        + "      float t = _rmin;\n"
        + "      _rmin = _rmax;\n"
        + "      _rmax = t;\n"
        ...
        + "    _dr = _rmax - _rmin;\n"
        + "\n"
        + "    _zmin = __polarplot2d_wf_zmin;\n"
        + "    _zmax = __polarplot2d_wf_zmax;\n"
        + "    if (_zmin > _zmax) {\n"
        + "      float t = _zmin;\n"
        + "      _zmin = _zmax;\n"
        + "      _zmax = t;\n"
        ...
        + "float r = eval%d_polarplot2d_wf(t, __polarplot2d_wf_param_a, __polarplot2d_wf_param_b, __polarplot2d_wf_param_c, __polarplot2d_wf_param_d, __polarplot2d_wf_param_e, __polarplot2d_wf_param_f);\n"
        + "float x = r * cosf(t);\n"
        + "float y = r * sinf(t);\n\n"
        + "if(lroundf(__polarplot2d_wf_direct_color)>0) {\n"
        + "  switch (lroundf(__polarplot2d_wf_color_mode)) {\n"
        + "        case 0:\n"
        + "          break;\n"
        + "        case 2:\n"
        + "          __pal = (r - _rmin) / _dr;\n"
        ...
        + "}\n"
        + "__px += __polarplot2d_wf * x;\n"
        + "__py += __polarplot2d_wf * y;\n"
        + "__pz += __polarplot2d_wf * z;\n";
  }
