...
public class YPlot3DWFFunc extends VariationFunc implements SupportsGPU {
  ...
  private String id_reference = "org.jwildfire.create.tina.variation.reference.ReferenceFile yplot3d-presets.pdf";
  ...
  private void validatePresetId() {
    if (preset_id >= 0) {
      YPlot3DWFFuncPreset preset =
          WFFuncPresetsStore.getYPlot3DWFFuncPresets().getPreset(preset_id);
  ...
  public String getGPUCode(FlameTransformationContext context) {
    return "float _xmin, _xmax, _dx;\n"
            ...
            + "_xmin = __yplot3d_wf_xmin;\n"
            + "    _xmax = __yplot3d_wf_xmax;\n"
            + "    if (_xmin > _xmax) {\n"
            + "      float t = _xmin;\n"
            + "      _xmin = _xmax;\n"
            + "      _xmax = t;\n"
            ...
            + "    _dx = _xmax - _xmin;\n"
            + "\n"
            + "    _ymin = __yplot3d_wf_ymin;\n"
            + "    _ymax = __yplot3d_wf_ymax;\n"
            + "    if (_ymin > _ymax) {\n"
            + "      float t = _ymin;\n"
            + "      _ymin = _ymax;\n"
            + "      _ymax = t;\n"
            ...
            + "    _dy = _ymax - _ymin;\n"
            + "\n"
            + "    _zmin = __yplot3d_wf_zmin;\n"
            + "    _zmax = __yplot3d_wf_zmax;\n"
            + "    if (_zmin > _zmax) {\n"
            + "      float t = _zmin;\n"
            + "      _zmin = _zmax;\n"
            + "      _zmax = t;\n"
            ...
            + "float y = eval%d_yplot3d_wf(x, z, __yplot3d_wf_param_a, __yplot3d_wf_param_b, __yplot3d_wf_param_c, __yplot3d_wf_param_d, __yplot3d_wf_param_e, __yplot3d_wf_param_f);\n"
            + "if(lroundf(__yplot3d_wf_direct_color)>0) {\n"
            + "  switch (lroundf(__yplot3d_wf_color_mode)) {\n"
            + "        case 0:\n"
            + "          break;\n"
            + "        case 2:\n"
            + "          __pal = (y - _ymin) / _dy;\n"
