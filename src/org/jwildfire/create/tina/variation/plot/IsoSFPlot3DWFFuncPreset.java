...
public class IsoSFPlot3DWFFuncPreset extends WFFuncPreset {
  ...
  public IsoSFPlot3DWFFuncPreset(int id, String formula, double xmin, double xmax, double ymin, double ymax, double zmin, double zmax, double param_a, double param_b, double param_c, double param_d, double param_e, double param_f) {
    super(id);
