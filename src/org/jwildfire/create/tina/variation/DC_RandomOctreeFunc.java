	 ...
	 @Override
	  public String getGPUCode(FlameTransformationContext context) {
	    return   "float x,y;"
	    		...
	    		+"float z=0.5;"
	    		+"if( varpar->dc_randomoctree_ColorOnly ==1)"
	    		+"{"
	    		+"  x=__x;"
	    		+"  y=__y;"
	    		+"}"
	    		...
	    		+"color=dc_randomoctree_getRGBColor(uv,varpar->dc_randomoctree_time,varpar->dc_randomoctree_steps,"
	    		+"              varpar->dc_randomoctree_rotLR,varpar->dc_randomoctree_rotUD,varpar->dc_randomoctree_grid,"
	    		+"              varpar->dc_randomoctree_borders,varpar->dc_randomoctree_bBorders);"
	    		+"if( varpar->dc_randomoctree_Gradient ==0 )"
	    		+"{"
	    		+"   __useRgb  = true;"
	    		+"   __colorR  = color.x;"
	    		+"   __colorG  = color.y;"
	    		...
	    		+"   __colorA  = 1.0;"
	    		+"}"
	    		+"else if( varpar->dc_randomoctree_Gradient ==1 )"  
	    		+"{"
...
////use nearest palette color as the pixel color                
	    		...
	    		+"   __colorA  = 1.0;"
	    		+"}"
	    		+"else if( varpar->dc_randomoctree_Gradient ==2 )"
	    		+"{"
	    		+"  int3 icolor=dbl2int(color);"
	    		+"  float z=greyscale((float)icolor.x,(float)icolor.y,(float)icolor.z);"
	    		+"  __pal=z;"
	    		+"}"
	    		+"__px+= varpar->dc_randomoctree*x;"
	    		+"__py+= varpar->dc_randomoctree*y;"
	    		+"float dz = z * varpar->dc_randomoctree_scale_z + varpar->dc_randomoctree_offset_z;"
	    		+"if ( varpar->dc_randomoctree_reset_z  == 1) {"
	    		+"     __pz = dz;"
	    		+"}"
	    		+"else {"
	    		+"   __pz += dz;"
