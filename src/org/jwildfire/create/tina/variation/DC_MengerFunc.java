	 ...
	 @Override
	  public String getGPUCode(FlameTransformationContext context) {
	    return   "float x,y;"
	    		...
	    		+"  y=2.0*RANDFLOAT()-1.0;"
	    		+"}"
	    		+"float2 uv=make_float2(x,y)*__dc_menger_zoom;"
	    		+"color=dc_menger_getRGBColor(uv,__dc_menger_level);"
	    		+"if( __dc_menger_Gradient ==0 )"
	    		+"{"
	    		+"   __useRgb  = true;"
	    		+"   __colorR  = color.x;"
	    		+"   __colorG  = color.y;"
	    		...
	    		+"   __colorA  = 1.0;"
	    		+"}"
	    		+"else if( __dc_menger_Gradient ==1 )"
	    		+"{"
...
////use nearest palette color as the pixel color                
	    		...
	    		+"   __colorA  = 1.0;"
	    		+"}"
	    		+"else if( __dc_menger_Gradient ==2 )"
	    		+"{"
	    		...
	    		+"__px+= __dc_menger*x;"
	    		+"__py+= __dc_menger*y;"
	    		+"float dz = z * __dc_menger_scale_z + __dc_menger_offset_z;"
	    		+"if ( __dc_menger_reset_z  == 1) {"
	    		+"     __pz = dz;"
	    		+"}"
	    		+"else {"
	    		+"   __pz += dz;"
