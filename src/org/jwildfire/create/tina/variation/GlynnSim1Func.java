...
public class GlynnSim1Func extends VariationFunc implements SupportsGPU {
  ...
  public String getGPUCode(FlameTransformationContext context) {
    return " float a = PI * __glynnSim1_phi1 / 180.0;\n"
        + "    float sinPhi1 = sinf(a);\n"
        + "    float cosPhi1 = cosf(a);\n"
        + "    float _x1 = __glynnSim1_radius * cosPhi1;\n"
        + "    float _y1 = __glynnSim1_radius * sinPhi1;\n"
        + "    float _absPow = fabsf(__glynnSim1_pow);\n"
        + "    float r = sqrtf(__x * __x + __y * __y);\n"
        + "    float Alpha = __glynnSim1_radius / r;\n"
        + "    float x, y;\n"
        + "    if (r < __glynnSim1_radius) {\n"
        + "      glynnSim1_circle(&x, &y, RANDFLOAT(), RANDFLOAT(), __glynnSim1_radius1, __glynnSim1_thickness, _x1, _y1);\n"
        + "      __px += __glynnSim1 * x;\n"
        + "      __py += __glynnSim1 * y;\n"
        + "    } else {\n"
        + "      if (RANDFLOAT() > __glynnSim1_contrast * powf(Alpha, _absPow)) {\n"
        + "        x = __x;\n"
        + "        y = __y;\n"
        + "      } else {\n"
        + "        x = Alpha * Alpha * __x;\n"
        ...
        + "      if (Z < __glynnSim1_radius1 * __glynnSim1_radius1) {\n"
        + "        glynnSim1_circle(&x, &y, RANDFLOAT(), RANDFLOAT(), __glynnSim1_radius1, __glynnSim1_thickness, _x1, _y1);\n"
        + "        __px += __glynnSim1 * x;\n"
        + "        __py += __glynnSim1 * y;\n"
        + "      } else {\n"
        ...
        + "      }\n"
        + "    }\n"
        + (context.isPreserveZCoordinate() ? "      __pz += __glynnSim1 * __z;\n" : "");
  }
