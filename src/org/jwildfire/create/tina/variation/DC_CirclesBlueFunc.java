...
public class DC_CirclesBlueFunc  extends DC_BaseFunc {
	...
	private static final String[] paramNames = { PARAM_DC,PARAM_SEED,PARAM_TIME,PARAM_ZOOM,PARAM_RADIUS,PARAM_BUBLES,PARAM_GRADIENT};
	...
	public Object[] getParameterValues() { //re_min,re_max,im_min,im_max,
		return new Object[] { colorOnly,seed, time,zoom,fRadius,bubles,gradient};
	}
