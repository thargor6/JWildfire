...
public class SymNetG13Func extends VariationFunc implements SupportsGPU{
  ...
  private double spacex = 2.0;
  private double spacey = 2.0;
  ...
  double [][]transfs = {
		      ...
		      {-0.5 ,-0.866 , -0.0 , -0.866 ,  0.50 , 0.0},  // 2 
		      {-0.5 , 0.866 , -0.0 ,  0.866 ,  0.50 , 0.0},   // 3
  ...
  double x,y;
	   ...
	   vec2 z =new vec2(x,y);
	   z=z.plus(new vec2(spacex,spacey));
	    vec2 f=f(z);
  ...
  public VariationFuncType[] getVariationTypes() {
	...
	public String getGPUCode(FlameTransformationContext context) {
	    return   "float x,y;"
	    		...
	    		+"  float spacex=sqrtf(varpar->sym_ng13_radius*varpar->sym_ng13_radius/2.0);"
	    		+"  float spacey=spacex;"
	    		+"  float sx=varpar->sym_ng13_stepx/2.0;"
	    		+"  float sy=varpar->sym_ng13_stepy/2.0;"
	    		...
	    		+"  __px += varpar->sym_ng13 * (f.x);"
	    		+"  __py += varpar->sym_ng13 * (f.y);"
	            + (context.isPreserveZCoordinate() ? "__pz += varpar->sym_ng13 * __z;\n" : "");
	  }  
}
