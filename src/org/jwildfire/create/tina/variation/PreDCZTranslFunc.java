...
public class PreDCZTranslFunc extends VariationFunc implements SupportsGPU {
  ...
  public String getGPUCode(FlameTransformationContext context) {
    return "float _x0 = __pre_dcztransl_x0 < __pre_dcztransl_x1 ? __pre_dcztransl_x0 : __pre_dcztransl_x1;\n"
        + "float _x1 = __pre_dcztransl_x0 > __pre_dcztransl_x1 ? __pre_dcztransl_x0 : __pre_dcztransl_x1;\n"
        + "float _x1_m_x0 = _x1 - _x0 == 0 ? 1.e-6f : _x1 - _x0;\n"
        + "    float zf = __pre_dcztransl_factor * (__pal - _x0) / _x1_m_x0;\n"
        + "    if (lroundf(__pre_dcztransl_clamp) != 0)\n"
        + "      zf = zf < 0 ? 0 : zf > 1 ? 1 : zf;\n"
        + "    __x = __pre_dcztransl * __x;\n"
        + "    __y = __pre_dcztransl * __y;\n"
        + "\n"
        + "    if (lroundf(__pre_dcztransl_overwrite) == 0)\n"
        + "      __z = __pre_dcztransl * __z * zf;\n"
        + "    else\n"
        + "      __z = __pre_dcztransl * zf;"
