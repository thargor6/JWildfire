...
public class QuaternionFunc extends VariationFunc implements SupportsGPU {
  ...
  public String getGPUCode(FlameTransformationContext context) {
    return   "    float x = 0.0, y = 0.0, z = 0.0;"
    		+"    float denom = 0.5 * __quaternion / logf( __quaternion_logqbase );"
    		+"    if ( __quaternion_cosqpow  != 0) {"
    		+"      float cosqabs_v = hypotf(__y, __z) *  __quaternion_cosqz1 ;"
    		+"      float cosqs = sinf(__x *  __quaternion_cosqx1 );"
    		+"      float cosqc = cosf(__x *  __quaternion_cosqx2 );"
    		+"      float cosqsh = sinhf(cosqabs_v *  __quaternion_cosqy1 );"
    		+"      float cosqch = coshf(cosqabs_v *  __quaternion_cosqy2 );"
    		+"      float cosqC = __quaternion * cosqs * cosqsh / cosqabs_v *  __quaternion_cosqz2 ;"
    		+"      x +=  __quaternion_cosqpow  * __quaternion * cosqc * cosqch;"
    		+"      y +=  __quaternion_cosqpow  * cosqC * __y;"
    		+"      z +=  __quaternion_cosqpow  * cosqC * __z;"
    		+"    }"
    		+"    if ( __quaternion_coshqpow  != 0) {"
    		+"      float coshqabs_v = hypotf(__y, __z) *  __quaternion_coshqz1 ;"
    		+"      float coshqs = sinf(coshqabs_v *  __quaternion_coshqy1 );"
    		+"      float coshqc = cosf(coshqabs_v *  __quaternion_coshqy2 );"
    		+"      float coshqsh = sinhf(__x *  __quaternion_coshqx1 );"
    		+"      float coshqch = coshf(__x *  __quaternion_coshqx2 );"
    		+"      float coshqC = __quaternion * coshqsh * coshqs / coshqabs_v *  __quaternion_coshqz2 ;"
    		+"      x +=  __quaternion_coshqpow  * __quaternion * coshqch * coshqc;"
    		+"      y +=  __quaternion_coshqpow  * coshqC * __y;"
    		+"      z +=  __quaternion_coshqpow  * coshqC * __z;"
    		+"    }"
    		+"    if ( __quaternion_cotqpow  != 0) {"
    		+"      float cotqabs_v = hypotf(__y, __z) *  __quaternion_cotqz1 ;"
    		+"      float cotqs = sinf(__x *  __quaternion_cotqx1 );"
    		+"      float cotqc = cosf(__x *  __quaternion_cotqx2 );"
    		+"      float cotqsh = sinhf(cotqabs_v *  __quaternion_cotqy1 );"
    		+"      float cotqch = coshf(cotqabs_v *  __quaternion_cotqy2 );"
    		+"      float cotqsysz = __y*__y + __z*__z;"
    		+"      float cotqni = __quaternion / (__x*__x + cotqsysz);"
    		+"      float cotqC = cotqc * cotqsh / cotqabs_v *  __quaternion_cotqz2 ;"
    		+"      float cotqB = -cotqs * cotqsh / cotqabs_v;"
    		+"      float cotqstcv = cotqs * cotqch;"
    		+"      float cotqnstcv = -cotqstcv;"
    		+"      float cotqctcv = cotqc * cotqch;"
    		+"      x +=  __quaternion_cotqpow  * (cotqstcv * cotqctcv + cotqC * cotqB * cotqsysz)"
    		+"              * cotqni;"
    		+"      y -=  __quaternion_cotqpow "
    		+"              * (cotqnstcv * cotqB * __y + cotqC * __y"
    		+"              * cotqctcv) * cotqni;"
    		+"      z -=  __quaternion_cotqpow "
    		+"              * (cotqnstcv * cotqB * __z + cotqC * __z"
    		+"              * cotqctcv) * cotqni;"
    		+"    }"
    		+"    if ( __quaternion_cothqpow  != 0) {"
    		+"      float cothqabs_v = hypotf(__y, __z) *  __quaternion_cothqz1 ;"
    		+"      float cothqs = sinf(cothqabs_v *  __quaternion_cothqy1 );"
    		+"      float cothqc = cosf(cothqabs_v *  __quaternion_cothqy2 );"
    		+"      float cothqsh = sinhf(__x *  __quaternion_cothqx1 );"
    		+"      float cothqch = coshf(__x *  __quaternion_cothqx2 );"
    		+"      float cothqsysz = __y*__y + __z*__z;"
    		+"      float cothqni = __quaternion / (__x*__x + cothqsysz);"
    		+"      float cothqC = cothqch * cothqs / cothqabs_v *  __quaternion_cothqz2 ;"
    		...
    		+"      x +=  __quaternion_cothqpow "
    		+"              * (cothqstcv * cothqctcv + cothqC * cothqB * cothqsysz)"
    		+"              * cothqni;"
    		+"      y +=  __quaternion_cothqpow "
    		+"              * (cothqnstcv * cothqB * __y + cothqC * __y"
    		+"              * cothqctcv) * cothqni;"
    		+"      z +=  __quaternion_cothqpow "
    		+"              * (cothqnstcv * cothqB * __z + cothqC * __z"
    		+"              * cothqctcv) * cothqni;"
    		+"    }"
    		+"    if ( __quaternion_cscqpow  != 0) {"
    		+"      float cscqabs_v = hypotf(__y, __z) *  __quaternion_cscqz1 ;"
    		+"      float cscqs = sinf(__x *  __quaternion_cscqx1 );"
    		+"      float cscqc = cosf(__x *  __quaternion_cscqx2 );"
    		+"      float cscqsh = sinhf(cscqabs_v *  __quaternion_cscqy1 );"
    		+"      float cscqch = coshf(cscqabs_v *  __quaternion_cscqy2 );"
    		+"      float cscqni = __quaternion"
    		+"              / (__x*__x + __y*__y + __z*__z);"
    		+"      float cscqC = cscqni * cscqc * cscqsh / cscqabs_v *  __quaternion_cscqz2 ;"
    		+"      x +=  __quaternion_cscqpow  * cscqs * cscqch * cscqni;"
    		+"      y -=  __quaternion_cscqpow  * cscqC * __y;"
    		+"      z -=  __quaternion_cscqpow  * cscqC * __z;"
    		+"    }"
    		+"    if ( __quaternion_cschqpow  != 0) {"
    		+"      float cschqabs_v = hypotf(__y, __z) *  __quaternion_cschqz1 ;"
    		+"      float cschqs = sinf(cschqabs_v *  __quaternion_cschqy1 );"
    		+"      float cschqc = cosf(cschqabs_v *  __quaternion_cschqy2 );"
    		+"      float cschqsh = sinhf(__x *  __quaternion_cschqx1 );"
    		+"      float cschqch = coshf(__x *  __quaternion_cschqx2 );"
    		+"      float cschqni = __quaternion"
    		+"              / (__x*__x + __y*__y + __z*__z);"
    		+"      float cschqC = cschqni * cschqch * cschqs / cschqabs_v *  __quaternion_cschqz2 ;"
    		+"      x +=  __quaternion_cschqpow  * cschqsh * cschqc * cschqni;"
    		+"      y -=  __quaternion_cschqpow  * cschqC * __y;"
    		+"      z -=  __quaternion_cschqpow  * cschqC * __z;"
    		+"    }"
    		+"    if ( __quaternion_estiqpow  != 0) {"
    		+"      float estiqe = expf(__x *  __quaternion_estiqx1 );"
    		+"      float estiqabs_v = hypotf(__y, __z) *  __quaternion_estiqz1 ;"
    		+"      float estiqs = sinf(estiqabs_v *  __quaternion_estiqy1 );"
    		+"      float estiqc = cosf(estiqabs_v *  __quaternion_estiqy2 );"
    		+"      float estiqa = estiqe * estiqs / estiqabs_v *  __quaternion_estiqz2 ;"
    		+"      x +=  __quaternion_estiqpow  * __quaternion * estiqe * estiqc;"
    		+"      y +=  __quaternion_estiqpow  * __quaternion * estiqa * __y;"
    		+"      z +=  __quaternion_estiqpow  * __quaternion * estiqa * __z;"
    		+"    }"
    		+"    if ( __quaternion_logqpow  != 0) {"
    		+"      float logqabs_v = hypotf(__y, __z);"
    		+"      float logqC = __quaternion * atan2f(logqabs_v, __x) / logqabs_v;"
    		+"      x +=  __quaternion_logqpow  * logf(__x*__x + logqabs_v*logqabs_v) * denom;"
    		+"      y +=  __quaternion_logqpow  * logqC * __y;"
    		+"      z +=  __quaternion_logqpow  * logqC * __z;"
    		+"    }"
    		+"    if ( __quaternion_secqpow  != 0) {"
    		+"      float secqabs_v = hypotf(__y, __z) *  __quaternion_secqz1 ;"
    		+"      float secqs = sinf(-__x *  __quaternion_secqx1 );"
    		+"      float secqc = cosf(-__x *  __quaternion_secqx2 );"
    		+"      float secqsh = sinhf(secqabs_v *  __quaternion_secqy1 );"
    		+"      float secqch = coshf(secqabs_v *  __quaternion_secqy2 );"
    		+"      float secqni = __quaternion"
    		+"              / (__x*__x + __y*__y + __z*__z);"
    		+"      float secqC = secqni * secqs * secqsh / secqabs_v *  __quaternion_secqz2 ;"
    		+"      x +=  __quaternion_secqpow  * secqc * secqch * secqni;"
    		+"      y -=  __quaternion_secqpow  * secqC * __y;"
    		+"      z -=  __quaternion_secqpow  * secqC * __z;"
    		+"    }"
    		+"    if ( __quaternion_sechqpow  != 0) {"
    		+"      float sechqabs_v = hypotf(__y, __z) *  __quaternion_sechqz1 ;"
    		+"      float sechqs = sinf(sechqabs_v *  __quaternion_sechqy1 );"
    		+"      float sechqc = cosf(sechqabs_v *  __quaternion_sechqy2 );"
    		+"      float sechqsh = sinhf(__x *  __quaternion_sechqx1 );"
    		+"      float sechqch = coshf(__x *  __quaternion_sechqx2 );"
    		+"      float sechqni = __quaternion"
    		+"              / (__x*__x + __y*__y + __z*__z);"
    		+"      float sechqC = sechqni * sechqsh * sechqs / sechqabs_v *  __quaternion_sechqz2 ;"
    		+"      x +=  __quaternion_sechqpow  * sechqch * sechqc * sechqni;"
    		+"      y -=  __quaternion_sechqpow  * sechqC * __y;"
    		+"      z -=  __quaternion_sechqpow  * sechqC * __z;"
    		+"    }"
    		+"    if ( __quaternion_tanqpow  != 0) {"
    		+"      float tanqabs_v = hypotf(__y, __z) *  __quaternion_tanqz1 ;"
    		+"      float tanqs = sinf(__x *  __quaternion_tanqx1 );"
    		+"      float tanqc = cosf(__x *  __quaternion_tanqx2 );"
    		+"      float tanqsh = sinhf(tanqabs_v *  __quaternion_tanqy1 );"
    		+"      float tanqch = coshf(tanqabs_v *  __quaternion_tanqy2 );"
    		+"      float tanqsysz = __y*__y + __z*__z;"
    		+"      float tanqni = __quaternion / (__x*__x + tanqsysz);"
    		+"      float tanqC = tanqc * tanqsh / tanqabs_v *  __quaternion_tanqz2 ;"
    		+"      float tanqB = -tanqs * tanqsh / tanqabs_v;"
    		+"      float tanqstcv = tanqs * tanqch;"
    		+"      float tanqnstcv = -tanqstcv;"
    		+"      float tanqctcv = tanqc * tanqch;"
    		+"      x +=  __quaternion_tanqpow  * (tanqstcv * tanqctcv + tanqC * tanqB * tanqsysz)"
    		+"              * tanqni;"
    		+"      y +=  __quaternion_tanqpow "
    		+"              * (tanqnstcv * tanqB * __y + tanqC * __y"
    		+"              * tanqctcv) * tanqni;"
    		+"      z +=  __quaternion_tanqpow "
    		+"              * (tanqnstcv * tanqB * __z + tanqC * __z"
    		+"              * tanqctcv) * tanqni;"
    		+"    }"
    		+"    if ( __quaternion_tanhqpow  != 0) {"
    		+"      float tanhqabs_v = hypotf(__y, __z) *  __quaternion_tanhqz1 ;"
    		+"      float tanhqs = sinf(tanhqabs_v *  __quaternion_tanhqy1 );"
    		+"      float tanhqc = cosf(tanhqabs_v *  __quaternion_tanhqy2 );"
    		+"      float tanhqsh = sinhf(__x *  __quaternion_tanhqx1 );"
    		+"      float tanhqch = coshf(__x *  __quaternion_tanhqx2 );"
    		+"      float tanhqsysz = __y*__y + __z*__z;"
    		+"      float tanhqni = __quaternion / (__x*__x + tanhqsysz);"
    		+"      float tanhqC = tanhqch * tanhqs / tanhqabs_v *  __quaternion_tanhqz2 ;"
    		...
    		+"      x +=  __quaternion_tanhqpow "
    		+"              * (tanhqstcv * tanhqctcv + tanhqC * tanhqB * tanhqsysz)"
    		+"              * tanhqni;"
    		+"      y +=  __quaternion_tanhqpow "
    		+"              * (tanhqnstcv * tanhqB * __y + tanhqC * __y"
    		+"              * tanhqctcv) * tanhqni;"
    		+"      z +=  __quaternion_tanhqpow "
    		+"              * (tanhqnstcv * tanhqB * __z + tanhqC * __z"
    		+"              * tanhqctcv) * tanhqni;"
    		+"    }"
    		+"    if ( __quaternion_sinqpow  != 0) {"
    		+"      float sinqabs_v = hypotf(__y, __z) *  __quaternion_sinqz1 ;"
    		+"      float sinqs = sinf(__x *  __quaternion_sinqx1 );"
    		+"      float sinqc = cosf(__x *  __quaternion_sinqx2 );"
    		+"      float sinqsh = sinhf(sinqabs_v *  __quaternion_sinqy1 );"
    		+"      float sinqch = coshf(sinqabs_v *  __quaternion_sinqy2 );"
    		+"      float sinqC = __quaternion * sinqc * sinqsh / sinqabs_v *  __quaternion_sinqz2 ;"
    		+"      x +=  __quaternion_sinqpow  * __quaternion * sinqs * sinqch;"
    		+"      y +=  __quaternion_sinqpow  * sinqC * __y;"
    		+"      z +=  __quaternion_sinqpow  * sinqC * __z;"
    		+"    }"
    		+"    if ( __quaternion_sinhqpow  != 0) {"
    		+"      float sinhqabs_v = hypotf(__y, __z) *  __quaternion_sinhqz1 ;"
    		+"      float sinhqs = sinf(sinhqabs_v *  __quaternion_sinhqy1 );"
    		+"      float sinhqc = cosf(sinhqabs_v *  __quaternion_sinhqy2 );"
    		+"      float sinhqsh = sinhf(__x *  __quaternion_sinhqx1 );"
    		+"      float sinhqch = coshf(__x *  __quaternion_sinhqx2 );"
    		+"      float sinhqC = __quaternion * sinhqch * sinhqs / sinhqabs_v *  __quaternion_sinhqz2 ;"
    		+"      x +=  __quaternion_sinhqpow  * __quaternion * sinhqsh * sinhqc;"
    		+"      y +=  __quaternion_sinhqpow  * sinhqC * __y;"
    		+"      z +=  __quaternion_sinhqpow  * sinhqC * __z;"
    		+"    }"
    		+"    __px += x;"
    		+"    __py += y;"
    		+"    __pz += z;";
