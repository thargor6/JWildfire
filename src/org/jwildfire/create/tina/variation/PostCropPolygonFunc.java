  ...
  return G.length(p) - r;
	...
	public String getGPUCode(FlameTransformationContext context) {
	    return   "		  float x,y;"
	    		...
	    		+"			float d=0.;"
	    		+"			if( __post_crop_polygon_type ==4)  "
	    		+"			{"
	    		+"				d = post_crop_polygon_sdHexagram( p,  __post_crop_polygon_radius );"
	    		+"			}"
	    		+"			else if ( __post_crop_polygon_type ==3) "
	    		+"			{"
	    		+"				d= post_crop_polygon_sdOctogon( p,  __post_crop_polygon_radius  );"
	    		+"			}"
	    		+"			else if( __post_crop_polygon_type ==2) "
	    		+"			{"
	    		+"				 d= post_crop_polygon_sdHexagon( p,__post_crop_polygon_radius );"
	    		+"			}"
	    		+"			else if( __post_crop_polygon_type ==1)  "
	    		+"			{"
	    		+"				d= post_crop_polygon_sdPentagon( p,__post_crop_polygon_radius );"
	    		+"			}"
	    		+"			else if( __post_crop_polygon_type ==0)  "
	    		+"			{"
	    		+"				d= post_crop_polygon_sdCircle( p,__post_crop_polygon_radius );"
	    		+"			}"
	    		+"		    __doHide=false;"
	    		+"		    if( __post_crop_polygon_invert ==0)"
	    		+"		    {"
	    		+"		      if (d>0.0)"
	    		+"		      { x=0.;"
	    		+"		        y=0.;"
	    		...
	    		+"			      }"
	    		+"		    }"
	    		+"		    __px = __post_crop_polygon * x;"
	    		+"		    __py = __post_crop_polygon * y;"
	            + (context.isPreserveZCoordinate() ? "__pz += __cut_polygon * __z;\n" : "");
	  }
	  @Override
