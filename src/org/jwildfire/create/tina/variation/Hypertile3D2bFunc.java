...
public class Hypertile3D2bFunc extends VariationFunc implements SupportsGPU {
    ...
    return "float pa, qa, cx, c2, c2x, s2x, s2y, s2z;\n"
        + "pa = __hypertile3D2b_b * PI / lroundf(__hypertile3D2b_p);\n"
        + "  qa = __hypertile3D2b_c * PI / lroundf(__hypertile3D2b_q);\n"
        + "\n"
        + "  float r = -(cosf(pa) - __hypertile3D2b_d) / (cosf(pa) + cosf(qa));\n"
        + "  if (r > 0)\n"
        + "   r = __hypertile3D2b_e / sqrtf(__hypertile3D2b_f + r);\n"
        + "  else\n"
        + "   r = 1.f;\n"
        + "\n"
        + "  cx = r;\n"
        + "  c2 = cx*cx;\n"
        + "  c2x = __hypertile3D2b_g * cx;\n"
        + "\n"
        + "  s2x = __hypertile3D2b_i + cx*cx;\n"
        + "  s2y = __hypertile3D2b_j - cx*cx;\n"
        + "  s2z = __hypertile3D2b_k - cx*cx;\n"
        ...
        + "  float y = __y * s2y;\n"
        + "\n"
        + "  float vr = __hypertile3D2b / (c2 * r2 + x2cx + __hypertile3D2b_h);\n"
        + "\n"
