...
public class SquishFunc extends VariationFunc implements SupportsGPU {
  ...
  public String getGPUCode(FlameTransformationContext context) {
    ...
    return "    float x = fabsf(__x);\n"
        ...
        + "    float p;\n"
        + "    float x2, y2;\n"
        + "    float inv_power = 1.0 / (float) __squish_power;\n"
        + "\n"
        + "    if ( x > y)\n"
        + "    {\n"
        + "        s = x;\n"
        ...
        + "    }\n"
        + "\n"
        + "    p = inv_power * (p + 8.0f * s * floorf(__squish_power * RANDFLOAT()));\n"
        + "\n"
        + "    if( p <= 1.0f* s )\n"
        + "    {\n"
        + "        __px += __squish * s;\n"
        ...
        + "    else if( p <= 3.0f * s)\n"
        + "    {\n"
        + "        __px += __squish * ( 2.0f * s - p);\n"
        + "        __py += __squish * (s);\n"
        + "    }\n"
        + "    else if( p <= 5.0f * s)\n"
        + "    {\n"
        + "        __px -= __squish * (s);\n"
        + "        __py += __squish * ( 4.0f * s - p);\n"
        + "    }\n"
        + "    else if( p <= 7.0f * s)\n"
        + "    {\n"
        + "        __px -= __squish * (6.0f * s - p);\n"
        + "        __py -= __squish * (s);\n"
        + "    }\n"
        + "    else\n"
        + "    {\n"
        + "        __px += __squish * (s);\n"
        + "        __py -= __squish * ( 8.0f * s - p);\n"
        + "    }\n"
        + (context.isPreserveZCoordinate() ? "    __pz += __squish*__z;\n": "");
  }
}
