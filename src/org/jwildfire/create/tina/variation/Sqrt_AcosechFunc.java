...
public class Sqrt_AcosechFunc extends SimpleVariationFunc implements SupportsGPU {
...
//Sqrt AcosecH by Whittaker Courtney 12-19-2018
  ...
  public String getGPUCode(FlameTransformationContext context) {
    return "Complex z;\n"
            ...
            + "Complex_Sqrt(&z);\n"
            + "Complex_AcosecH(&z);\n"
            + "Complex_Scale(&z, varpar->sqrt_acosech * 2.f / PI);\n"
            + "if(RANDFLOAT()<0.5) {\n"
            + "  __py += z.im;\n"
            + "  __px += z.re;\n"
            + "}\n"
            ...
            + "  __px += -z.re;\n"
            + "}\n"
            + (context.isPreserveZCoordinate() ? "__pz += varpar->sqrt_acosech * __z;\n": "");
  }
}
