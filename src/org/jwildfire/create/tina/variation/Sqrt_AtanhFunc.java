...
public class Sqrt_AtanhFunc extends SimpleVariationFunc implements SupportsGPU {
...
//Sqrt AtanH by Whittaker Courtney 12-19-2018
  ...
  public String getGPUCode(FlameTransformationContext context) {
    return   "    Complex z;"
    		...
    		+"    Complex_Sqrt(&z);"
    		+"    Complex_AtanH(&z);"
    		+"    Complex_Scale(&z,__sqrt_atanh * (2.0f / PI));"
    		+"    if (RANDFLOAT() < 0.5){"
    		+"      __py += z.im;"
    		+"      __px += z.re;"
    		+"    }"
    		...
    		+"      __px += -z.re;"
    		+"    }"
            + (context.isPreserveZCoordinate() ? "__pz += __sqrt_atanh *__z;" : "");
  }
}