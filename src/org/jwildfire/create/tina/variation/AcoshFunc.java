...
public class AcoshFunc extends SimpleVariationFunc implements SupportsGPU {
  ...
  public String getGPUCode(FlameTransformationContext context) {
    return "Complex z;\n"
            ...
            + "Complex_AcosH(&z);\n"
            + "Complex_Scale(&z, varpar->acosh * 2.f / PI);\n"
            + "if(RANDFLOAT()<0.5) {\n"
            + "  __py += z.im;\n"
            + "  __px += z.re;\n"
            + "}\n"
            ...
            + "  __px += -z.re;\n"
            + "}\n"
            + (context.isPreserveZCoordinate() ? "__pz += varpar->acosh * __z;\n": "");
  }
}
