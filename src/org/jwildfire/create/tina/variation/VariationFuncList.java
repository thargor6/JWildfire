...
VariationFuncList {
  ...
  static {
    ...
    registerVariationFunc(AftershockFunc.class);
    registerVariationFunc(AmoebaFunc.class);
    registerVariationFunc(AstroidFunc.class);
    ...
    registerVariationFunc(CirrusFunc.class);
    registerVariationFunc(CoagulationFunc.class);
    registerVariationFunc(CollisionFunc.class);
    registerVariationFunc(ColorWheelFunc.class);
    registerVariationFunc(ContourMapFunc.class);
    registerVariationFunc(CopperplateFunc.class);
    registerVariationFunc(CoronaFunc.class);
    registerVariationFunc(CumulonimbusFunc.class);
    registerVariationFunc(CurlNoiseFunc.class);
    registerVariationFunc(CycloneFunc.class);
    registerVariationFunc(DeltoidFunc.class);
    registerVariationFunc(DiamondLatticeFunc.class);
    ...
    registerVariationFunc(GearTeethFunc.class);
    registerVariationFunc(GingerbreadFunc.class);
    registerVariationFunc(GnomonicProjFunc.class);
    registerVariationFunc(GothicArchFunc.class);
    registerVariationFunc(GradientWarpFunc.class);
    registerVariationFunc(HaloFunc.class);
    registerVariationFunc(HammerFunc.class);
    registerVariationFunc(HexagonalFunc.class);
    registerVariationFunc(HoneycombFunc.class);
    registerVariationFunc(IkedaFunc.class);
    ...
    registerVariationFunc(NephroidFunc.class);
    registerVariationFunc(OuroborosFunc.class);
    registerVariationFunc(PWaveFunc.class);
    registerVariationFunc(PDJv2Func.class);
    registerVariationFunc(PenroseFoldFunc.class);
    registerVariationFunc(PhyllotaxisFunc.class);
    registerVariationFunc(PickoverFunc.class);
    registerVariationFunc(PistonFunc.class);
    registerVariationFunc(PleatFunc.class);
    registerVariationFunc(QuadrapoleFunc.class);
    registerVariationFunc(QuasicrystalFunc.class);
    registerVariationFunc(QuiltFunc.class);
    registerVariationFunc(QuintessenceFunc.class);
    ...
    registerVariationFunc(RobinsonFunc.class);
    ...
    registerVariationFunc(ScrewFunc.class);
    ...
    registerVariationFunc(StereographicFunc.class);
    ...
    registerVariationFunc(TaperFunc.class);
    registerVariationFunc(TentacleFunc.class);
    ...
    registerVariationFunc(ToroidalFunc.class);
    registerVariationFunc(TorusKnotFunc.class);
    registerVariationFunc(TriLatticeFunc.class);
    registerVariationFunc(TunnelingFunc.class);
    registerVariationFunc(TurbulenceFunc.class);
    registerVariationFunc(TweedFunc.class);
    registerVariationFunc(VineFunc.class);
    registerVariationFunc(VirusFunc.class);
    registerVariationFunc(VoronoiFoldFunc.class);
    registerVariationFunc(VortexFunc.class);
    registerVariationFunc(WaveFuncFunc.class);
    registerVariationFunc(Waves3dDecayFunc.class);
    registerVariationFunc(WavesPhaseFunc.class);
