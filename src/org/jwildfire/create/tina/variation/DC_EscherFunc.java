...
public class DC_EscherFunc  extends DC_BaseFunc {
	...
	private static final String[] paramNames = { PARAM_DC,PARAM_SHIFT,PARAM_SEED,PARAM_TIME,PARAM_ZOOM,PARAM_GRADIENT};
...
/*		vec2 u_mouse=new vec2(shift*resolutionY);
	...
	public Object[] getParameterValues() { //re_min,re_max,im_min,im_max,
		return new Object[] { colorOnly,shift,seed,time,zoom, gradient};
	}
