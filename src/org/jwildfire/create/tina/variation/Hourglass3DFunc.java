...
public class Hourglass3DFunc extends VariationFunc {
  ...
  private static final String[] paramNames = {
    PARAM_KX, PARAM_KY, PARAM_KZ, PARAM_MAXHEIGHT, PARAM_LIMIT, PARAM_ZERO
  };
  ...
  public void transform(
    ...
    if (limit == 0) calc(pContext, pXForm, pAffineTP, pVarTP, pAmount);
    else if (zero == 0) calcCutBoarder(pContext, pXForm, pAffineTP, pVarTP, pAmount);
    else calcCut(pContext, pXForm, pAffineTP, pVarTP, pAmount);
  }
  ...
  public void setParameter(String pName, double pValue) {
    ...
    } else if (PARAM_LIMIT.equalsIgnoreCase(pName)) limit = pValue <= EPSILON ? 0 : 1;
    else if (PARAM_ZERO.equalsIgnoreCase(pName)) zero = pValue <= EPSILON ? 0 : 1;
