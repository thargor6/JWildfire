...
public class PostHeatFunc extends VariationFunc implements SupportsGPU {
  ...
  public String getGPUCode(FlameTransformationContext context) {
    return "    float tx = __post_heat_theta_period == 0 ? 0.0 : 1.0 / __post_heat_theta_period;\n"
        + "    float px = __post_heat_phi_period == 0 ? 0.0 : 1.0 / __post_heat_phi_period;\n"
        + "    float rx = __post_heat_r_period == 0 ? 0.0 : 1.0 / __post_heat_r_period;\n"
        + "    float at, bt, ct, ap, bp, cp, ar, br, cr;\n"
        + "    at = __post_heat * __post_heat_theta_amp;\n"
        + "    bt = (2.0f*PI) * tx;\n"
        + "    ct = __post_heat_theta_phase * tx;\n"
        + "    ap = __post_heat * __post_heat_phi_amp;\n"
        + "    bp = (2.0f*PI) * px;\n"
        + "    cp = __post_heat_phi_phase * px;\n"
        + "    ar = __post_heat * __post_heat_r_amp;\n"
        + "    br = (2.0f*PI) * rx;\n"
        + "    cr = __post_heat_r_phase * rx;\n"
        + "\n"
