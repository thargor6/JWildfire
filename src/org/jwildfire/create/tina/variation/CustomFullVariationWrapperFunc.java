...
public class CustomFullVariationWrapperFunc extends VariationFunc implements SupportsGPU {
  ...
  private static String default_code =
      "package org.jwildfire.create.tina.variation;\n"
          ...
          + "import org.jwildfire.create.tina.base.XYZPoint;\n"
          + "\n"
          + "public class DynamicCompiledLinear3DFunc extends SimpleVariationFunc implements SupportsGPU {\n"
          + "  private static final long serialVersionUID = 1L;\n"
          ...
          + "    // 3. use this name to specify the amount-parameter in the form varpar->[name]\n"
          ...
          + "    // 7. mathematical functions are postfixed with f, e.g. use sinf, cosf, logf, ... instead of sin, cos, log, ..."
          + "    // 8. a random number may be generated by using RANDFLOAT()\n"
          + "    // 9. you can NOT use global variables\n"
          + "    // 10. see the numerious existing variations for inspiration\n"
          + "    return \"__px += varpar->linear3D_dynamic * __x;\\n\"\n"
          + "         + \"__py += varpar->linear3D_dynamic * __y;\\n\"\n"
          + "         + (context.isPreserveZCoordinate() ? \"__pz += varpar->linear3D_dynamic * __z;\" : \"\");\n"
          + "  }\n"
          + "}\n";
  ...
  */
  ...
  public String getNameOfWrappedVariation() {
    return full_variation!=null ? full_variation.getName() : "";
  }

  @Override
  public String getGPUCode(FlameTransformationContext context) {
    if(full_variation!=null && full_variation instanceof SupportsGPU) {
      return ((SupportsGPU)full_variation).getGPUCode(context);
    }
    else {
      return "";
    }
  ...
  public String getGPUFunctions(FlameTransformationContext context) {
    if(full_variation!=null && full_variation instanceof SupportsGPU) {
      return ((SupportsGPU)full_variation).getGPUFunctions(context);
    }
    else {
      return "";
    }
  ...
  public boolean isStateful() {
    if(full_variation!=null && full_variation instanceof SupportsGPU) {
      return ((SupportsGPU)full_variation).isStateful();
    }
    else {
      return false;
    }
