...
public class Gridout3DFunc extends VariationFunc implements SupportsGPU {
    ...
    return "  float x = rintf(__x) * __gridout3D_xx;\n"
        + "  float y = rintf(__y) * __gridout3D_yy;\n"
        + "  if (y <= 0.0) {\n"
        + "   if (x > 0.0) {\n"
        + "    if (-y >= x) {\n"
        + "     __px += __gridout3D * (__x + __gridout3D_xa);\n"
        + "     __py += __gridout3D * (__y + __gridout3D_ya);\n"
        + "     __pz += __gridout3D * (__z + __gridout3D_za);\n"
        + "    } else {\n"
        + "     __px += __gridout3D * (__x + __gridout3D_xb);\n"
        + "     __py += __gridout3D * (__y + __gridout3D_yb);\n"
        + "     __pz += __gridout3D * (__z + __gridout3D_zb);\n"
        + "    }\n"
        + "   } else {\n"
        + "    if (y <= x) {\n"
        + "     __px += __gridout3D * (__x + __gridout3D_xc);\n"
        + "     __py += __gridout3D * (__y + __gridout3D_yc);\n"
        + "     __pz += __gridout3D * (__z + __gridout3D_zc);\n"
        + "    } else {\n"
        + "     __px += __gridout3D * (__x + __gridout3D_xd);\n"
        + "     __py += __gridout3D * (__y - __gridout3D_yd);\n"
        + "     __pz += __gridout3D * (__z + __gridout3D_zd);\n"
        + "    }\n"
        + "   }\n"
        + "  } else  {\n"
        + "   if (x > 0.0) {\n"
        + "    if (y >= x ) {\n"
        + "     __px += __gridout3D * (__x - __gridout3D_xe);\n"
        + "     __py += __gridout3D * (__y + __gridout3D_ye);\n"
        + "     __pz += __gridout3D * (__z * __gridout3D_ze);\n"
        + "    } else {\n"
        + "     __px += __gridout3D * (__x + __gridout3D_xf);\n"
        + "     __py += __gridout3D * (__y + __gridout3D_yf);\n"
        + "     __pz += __gridout3D * (__z * __gridout3D_zf);\n"
        + "    }\n"
        + "   } else {\n"
        + "    if (y > -x) {\n"
        + "     __px += __gridout3D * (__x - __gridout3D_xg);\n"
        + "     __py += __gridout3D * (__y + __gridout3D_yg);\n"
        + "     __pz += __gridout3D * (__z * __gridout3D_zg);\n"
        + "    } else {\n"
        + "     __px += __gridout3D * (__x + __gridout3D_xh);\n"
        + "     __py += __gridout3D * (__y - __gridout3D_yh);\n"
        + "     __pz += __gridout3D * (__z * __gridout3D_zh);\n"
        + "    }\n"
        + "   }\n"
        + "  }\n";
	}
