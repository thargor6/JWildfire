...
public abstract class AbstractFractWFFunc extends VariationFunc {
  ...
  private static final String[] paramNames = { PARAM_MAX_ITER, PARAM_XMIN, PARAM_XMAX, PARAM_YMIN, PARAM_YMAX, PARAM_XSEED, PARAM_YSEED, PARAM_DIRECT_COLOR, PARAM_SCALEZ, PARAM_CLIP_ITER_MIN, PARAM_CLIP_ITER_MAX, PARAM_MAX_CLIP_ITER, PARAM_SCALE, PARAM_OFFSETX, PARAM_OFFSETY, PARAM_OFFSETZ };
  ...
  protected double xseed = 0.10;
  protected double yseed = 0.70;
  ...
  protected int max_clip_iter = 12;
  ...
  public Object[] getParameterValues() {
    return new Object[] { max_iter, xmin, xmax, ymin, ymax, xseed, yseed, direct_color, scalez, clip_iter_min, clip_iter_max, max_clip_iter, scale, offsetx, offsety, offsetz };
  }
