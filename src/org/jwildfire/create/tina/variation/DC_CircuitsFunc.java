...
public class DC_CircuitsFunc  extends DC_BaseFunc implements SupportsGPU {
	...
	return   "float x,y;"
	    		...
	    		+"float z=0.5;"
	    		+"if( varpar->dc_circuits_ColorOnly ==1)"
	    		+"{"
	    		+"  x=__x;"
	    		+"  y=__y;"
	    		+"}"
	    		...
	    		+"color=dc_circuits_getRGBColor(uv,varpar->dc_circuits_time,varpar->dc_circuits_rate,varpar->dc_circuits_zoom,"
	    		+ "                             varpar->dc_circuits_focus,varpar->dc_circuits_loops,varpar->dc_circuits_glow,varpar->dc_circuits_intensity,varpar->dc_circuits_pulse);"
	    		+"if( varpar->dc_circuits_Gradient ==0 )"
	    		+"{"
	    		+"   __useRgb  = true;"
	    		+"   __colorR  = color.x;"
	    		+"   __colorG  = color.y;"
	    		...
	    		+"   __colorA  = 1.0;"
	    		+"}"
	    		+"else if( varpar->dc_circuits_Gradient ==1 )"  
	    		+"{"
	    		...
	    		+"   __colorA  = 1.0;"
	    		+"}"
	    		+"else if( varpar->dc_circuits_Gradient ==2 )"
	    		+"{"
	    		+"  int3 icolor=dbl2int(color);"
	    		+"  float z=greyscale((float)icolor.x,(float)icolor.y,(float)icolor.z);"
	    		+"  __pal=z;"
	    		+"}"
	    		+"__px+= varpar->dc_circuits*x;"
	    		+"__py+= varpar->dc_circuits*y;"
	    		+"float dz = z * varpar->dc_circuits_scale_z + varpar->dc_circuits_offset_z;"
	    		+"if ( varpar->dc_circuits_reset_z  == 1) {"
	    		+"     __pz = dz;"
	    		+"}"
	    		+"else {"
	    		+"   __pz += dz;"
