	 ...
	 @Override
	  public String getGPUCode(FlameTransformationContext context) {
	    return   "float x,y;"
	    		...
	    		+"  y=2.0*RANDFLOAT()-1.0;"
	    		+"}"
	    		+"float2 uv=make_float2(x,y)*__dc_kaliset2_zoom;"
	    		+"color=dc_kaliset2_getRGBColor(uv,__dc_kaliset2_time,__dc_kaliset2_N,"
	    		+"                                     __dc_kaliset2_radio, __dc_kaliset2_shiftX,"
	    		+ "                                    __dc_kaliset2_shiftY,__dc_kaliset2_redF, "
	    		+ "                                    __dc_kaliset2_greenF,__dc_kaliset2_blueF);"
	    		+"if( __dc_kaliset2_Gradient ==0 )"
	    		+"{"
	    		+"   __useRgb  = true;"
	    		+"   __colorR  = color.x;"
	    		+"   __colorG  = color.y;"
	    		...
	    		+"   __colorA  = 1.0;"
	    		+"}"
	    		+"else if( __dc_kaliset2_Gradient ==1 )"  
	    		+"{"
              ...
              +" }"          
	    		...
	    		+"   __colorA  = 1.0;"
	    		+"}"
	    		+"else if( __dc_kaliset2_Gradient ==2 )"
	    		+"{"
	    		+"  int3 icolor=dbl2int(color);"
	    		+"  float z=greyscale((float)icolor.x,(float)icolor.y,(float)icolor.z);"
	    		+"  __pal=z;"
	    		+"}"
	    		+"__px+= __dc_kaliset2*x;"
	    		+"__py+= __dc_kaliset2*y;"
	    		+"float dz = z * __dc_kaliset2_scale_z + __dc_kaliset2_offset_z;"
	    		+"if ( __dc_kaliset2_reset_z  == 1) {"
	    		+"     __pz = dz;"
	    		+"}"
	    		+"else {"
	    		+"   __pz += dz;"
