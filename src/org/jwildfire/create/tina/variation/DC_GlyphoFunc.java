	 ...
	 @Override
	  public String getGPUCode(FlameTransformationContext context) {
	    return   "float x,y;"
	    		...
	    		+"  y=2.0*RANDFLOAT()-1.0;"
	    		+"}"
	    		+"float2 uv=make_float2(x,y)*__dc_glypho_zoom;"
	    		+"color=dc_glypho_getRGBColor(uv,__dc_glypho_time,__dc_glypho_f1,__dc_glypho_f2,__dc_glypho_f3);"
	    		+"if( __dc_glypho_Gradient ==0 )"
	    		+"{"
	    		+"   __useRgb  = true;"
	    		+"   __colorR  = color.x;"
	    		+"   __colorG  = color.y;"
	    		...
	    		+"   __colorA  = 1.0;"
	    		+"}"
	    		+"else if( __dc_glypho_Gradient ==1 )"  
	    		+"{"
	    		...
	    		+"   __colorA  = 1.0;"
	    		+"}"
	    		+"else if( __dc_glypho_Gradient ==2 )"
	    		+"{"
	    		...
	    		+"__px+= __dc_glypho*x;"
	    		+"__py+= __dc_glypho*y;"
	    		+"float dz = z * __dc_glypho_scale_z + __dc_glypho_offset_z;"
	    		+"if ( __dc_glypho_reset_z  == 1) {"
	    		+"     __pz = dz;"
	    		+"}"
	    		+"else {"
	    		+"   __pz += dz;"
