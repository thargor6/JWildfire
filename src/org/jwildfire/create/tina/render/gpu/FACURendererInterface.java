...
public class FACURendererInterface implements GPURenderer {
  ...
  public boolean performSelfTests() {
    ...
    try {
      ...
      try {
        ...
        new FACUFlameWriter().writeFlame(Collections.singletonList(flame), tmpFile.getAbsolutePath());
        FACURenderResult openClRenderRes = FACURenderTools.invokeFACURender(tmpFile.getAbsolutePath(), 64, 64, 10, false);
