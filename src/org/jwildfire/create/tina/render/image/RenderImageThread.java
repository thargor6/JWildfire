...
public class RenderImageThread extends AbstractImageRenderThread {
  ...
  public RenderImageThread(Flame pFlame, LogDensityFilter pLogDensityFilter, GammaCorrectionFilter pGammaCorrectionFilter, int pStartRow, int pEndRow, SimpleImage pImg, PostDOFCalculator pDofCalculator, int pThreadId) {
