...
public class NBlurDOFBlurShape extends AbstractDOFBlurShape {
  ...
  private static final List<String> paramNames = new ArrayList<String>(Arrays.asList(new String[] { NBlurFunc.PARAM_NUMEDGES, NBlurFunc.PARAM_NUMSTRIPES, NBlurFunc.PARAM_RATIOSTRIPES, NBlurFunc.PARAM_RATIOHOLE, NBlurFunc.PARAM_CIRCUMCIRCLE }));
  ...
  public void setDefaultParams(Flame pFlame) {
    ...
    pFlame.setCamDOFParam1(3);// num edges
    pFlame.setCamDOFParam2(0);// num stripes
    pFlame.setCamDOFParam3(1);// ratio stripes
    pFlame.setCamDOFParam4(0);// ratio hole
