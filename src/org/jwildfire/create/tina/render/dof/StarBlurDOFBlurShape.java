...
public class StarBlurDOFBlurShape extends AbstractDOFBlurShape {
  ...
  private static final List<String> paramNames = new ArrayList<String>(Arrays.asList(new String[] { StarBlurFunc.PARAM_POWER, StarBlurFunc.PARAM_RANGE }));
  ...
  public void setDefaultParams(Flame pFlame) {
    ...
    pFlame.setCamDOFParam1(5);// power
