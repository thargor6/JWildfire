...
public final class TransformationPreparePreVariationsStep extends AbstractTransformationStep {
  private static final long serialVersionUID = 1L;

  public TransformationPreparePreVariationsStep(XForm pXForm) {
    super(pXForm);
  }
