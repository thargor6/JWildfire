...
public class RandomFlameGenerator {
  ...
  private static final String FNCLST_EXPERIMENTAL[] = { "blur3D", "bubble", "rays", "t_epispiral", "curl3D", "diamond", "disc",
      "butterfly3D", "conic", "julia3D", "fan2", "flower", "heart", "julia3D", "disc2", "polar2", "foci", "blade3D", "scry", "hemisphere", "popcorn2",
      "t_rose", "waves2", "twintrian", "super_shape", "bipolar", "horseshoe", "wedge", "cross", "tangent3D", "bent2", "blob3D", "julia3D",
      "pie3D", "pdj", "popcorn", "parabola", "rings2", "spherical3D", "spiral", "rectangles", "waves", "swirl", "boarders", "secant2" };
