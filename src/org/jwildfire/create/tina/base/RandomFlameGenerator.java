...
public class RandomFlameGenerator {
  ...
  private static final String FNCLST_EXPERIMENTAL[] = { "blur3D", "bubble", "escher", "rays", "t_epispiral", "curl3D", "diamond", "disc",
      "butterfly3D", "cpow", "conic", "julia3D", "fan2", "cell", "flower", "heart", "julia3D", "disc2", "polar2", "foci", "scry", "hemisphere", "popcorn2",
      "t_rose", "edisc", "waves2", "twintrian", "super_shape", "bipolar", "horseshoe", "wedge", "cross", "tangent3D", "curve", "bent2", "blob3D", "julia3D",
