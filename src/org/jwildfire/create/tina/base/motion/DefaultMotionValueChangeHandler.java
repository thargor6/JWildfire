...
public class DefaultMotionValueChangeHandler implements MotionValueChangeHandler, Serializable {
  ...
  public static final MotionValueChangeHandler INSTANCE = new DefaultMotionValueChangeHandler();

  @Override
  public void processValueChange(Object pTarget, String pPropertyName, double pValue) {
    AnimationService.setPropertyValue(pTarget, pPropertyName, pValue);
  }
