...
public final class PreInvVariationTransformationStep extends AbstractTransformationStep {
  private static final long serialVersionUID = 1L;

  private final Variation variation;

  public PreInvVariationTransformationStep(XForm pXForm, Variation pVariation) {
    super(pXForm);
