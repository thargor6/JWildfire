...
public class YAxisRandomSymmetryGenerator implements RandomSymmetryGenerator {

  @Override
  public void addSymmetry(Flame pFlame) {
    pFlame.setPostSymmetryType(PostSymmetryType.Y_AXIS);
    pFlame.setPostSymmetryCentreX(0.5 - Math.random());
    pFlame.setPostSymmetryCentreY(0.5 - Math.random());
    pFlame.setPostSymmetryDistance(-0.25 + Math.random() * 0.75);
    pFlame.setPostSymmetryRotation(0);
  }
