...
public class RandomFlameGeneratorList {
  ...
  static {
    ...
    registerRandomFlameGenerator(FlameWithBackgroundRandomFlameGenerator.class);
    ...
    registerRandomFlameGenerator(PainterlyRandomFlameGenerator.class);
    ...
    registerRandomFlameGenerator(SolidrecursiveRandomFlameGenerator.class);
    ...
    registerRandomFlameGenerator(UnderwaterRandomFlameGenerator.class);
