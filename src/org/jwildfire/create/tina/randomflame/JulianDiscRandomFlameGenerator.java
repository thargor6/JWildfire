...
public class JulianDiscRandomFlameGenerator extends RandomFlameGenerator {
  ...
  public Flame prepareFlame(RandomFlameGeneratorState pState) {
    ...
    flame.setPixelsPerUnit(200.0+Math.random()*60.0);
    ...
    if (Math.random() < 0.15) {
      ...
      if (Math.random() < 0.5) {
        String[] fncList = VariationFuncList.filterVariations(new String[] { "auger", "bent", "bent2", "boarders", "bubble", "butterfly", "bwraps7", "cosine",
