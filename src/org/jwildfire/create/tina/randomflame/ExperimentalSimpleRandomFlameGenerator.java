...
public class ExperimentalSimpleRandomFlameGenerator extends
  ...
  protected static final String FNCLST_EXPERIMENTAL[] = { "blur3D", "bubble",
      ...
      "conic", "julia3D", "cell", "stripes", "post_mirror_wf", "flipcircle",
      "colorscale_wf", "crackle", "truchet", "cannabiscurve_wf",
      "glynnSim3", "flower", "heart", "julia3D", "disc2", "polar2", "farblur",
      "foci", "scry", "flux", "bwraps7", "checks", "colorscale_wf", "falloff2",
      "cloverleaf_wf", "kaleidoscope", "eclipse", "hemisphere", "flipy",
      "popcorn2", "sec", "lazysusan", "sin", "separation", "bi_linear",
      "post_mirror_wf", "heart_wf", "mandelbrot", "cannabiscurve_wf",
      "rose_wf", "edisc", "waves2", "twintrian", "coth", "super_shape",
      "auger", "pre_wave3D_wf", "hexes", "spirograph", "truchet", "epispiral",
      "glynnSim2", "tanh", "bipolar", "cot", "horseshoe", "wedge", "unpolar",
      "modulus", "mobius", "bwraps7", "colorscale_wf", "truchet", "collideoscope",
