...
public class CrossRandomFlameGenerator extends RandomFlameGenerator {
  ...
  protected Flame prepareFlame(RandomFlameGeneratorState pState) {
    ...
    // create final transform 1
    {
      ...
      String variations[] = { "cross", "boarders2", "boarders", "butterfly", "cos", "cosh", "cosine", "cross2", "csc", "cylinder", "cylinder_apo", "dc_ztransl", "elliptic", "eyefish", "fibonacci2", "heart_wf", "hypertile1", "loonie", "mobius", "perspective", "popcorn", "popcorn2_3D", "ripple", "roundspher3D", "scry_3D", "sec", "secant2", "separation", "shredlin", "sin", "spherical", "spiral", "stripes", "unpolar", "waves2", "waves4_wf", "whorl", "xtrb" };
      String varName = Math.random() < 0.33 ? "cross" : variations[(int) (Math.random() * variations.length)];
