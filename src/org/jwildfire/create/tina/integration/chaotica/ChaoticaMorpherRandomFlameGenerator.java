...
// Meta-Random-Flame-Generator which "chaotifies" random flames generated by other generators (i. e. tranmsformes them that they can be exported to Chaotica)
public class ChaoticaMorpherRandomFlameGenerator extends RandomFlameGenerator {
  private static List<RandomFlameGenerator> generators;
  private ChaoticaMorpher chaotifier = new ChaoticaMorpher();
